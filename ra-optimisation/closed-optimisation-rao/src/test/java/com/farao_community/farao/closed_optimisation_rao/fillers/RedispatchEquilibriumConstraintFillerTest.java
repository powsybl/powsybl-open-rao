...
public class RedispatchEquilibriumConstraintFillerTest {
    ...
    RedispatchEquilibriumConstraintFiller redispatchEquilibriumConstraintFiller;
    ...
    public void setup() {
        ...
        redispatchEquilibriumConstraintFiller = new RedispatchEquilibriumConstraintFiller();
        redispatchEquilibriumConstraintFiller.initFiller(net, cracFile, data);
    }
