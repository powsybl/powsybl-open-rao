...
public class BranchMarginsVariablesFillerTest {
    ...
    @Test
    public void test() {
        Map<String, Class> data = branchMarginsVariablesFiller.dataExpected();
        branchMarginsVariablesFiller.constraintsProvided();
        branchMarginsVariablesFiller.variablesProvided();
        //TODO fillProblem()
    }
