...
pstBe.newPhaseTapChanger()
        ...
        .setTapPosition(-2)
        .add()
pstBe.getPhaseTapChanger().setTapPosition(-2)
...
crac = CracFile.builder()
        ...
        .remedialActions(Arrays.asList(
            RemedialAction.builder().id("PST_RA").name("Belgian PST remedial action")
                .remedialActionElements(Arrays.asList(PstElement.builder().id(pstBe.id).typeOfLimit(TypeOfLimit.ABSOLUTE).minStepRange(-2).maxStepRange(2).build()))
