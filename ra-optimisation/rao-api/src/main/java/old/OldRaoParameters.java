 ...
 */
public class OldRaoParameters extends AbstractExtendable<OldRaoParameters> {
    ...
    public OldRaoParameters setObjectiveFunction(ObjectiveFunction objectiveFunction) {
    ...
    public OldRaoParameters setMaxIterations(int maxIterations) {
    ...
    public OldRaoParameters setPstPenaltyCost(double pstPenaltyCost) {
    ...
    public OldRaoParameters setPstSensitivityThreshold(double pstSensitivityThreshold) {
    ...
    public OldRaoParameters setFallbackOverCost(double overCost) {
    ...
    public OldRaoParameters setRaoWithLoopFlowLimitation(boolean raoWithLoopFlowLimitation) {
    ...
    public OldRaoParameters setLoopFlowApproximationLevel(LoopFlowApproximationLevel loopFlowApproximation) {
    ...
    public OldRaoParameters setLoopFlowConstraintAdjustmentCoefficient(double loopFlowConstraintAdjustmentCoefficient) {
    ...
    public OldRaoParameters setLoopFlowViolationCost(double loopflowViolationCost) {
    ...
    public OldRaoParameters setDefaultSensitivityAnalysisParameters(SensitivityAnalysisParameters sensiParameters) {
    ...
    public OldRaoParameters setFallbackSensitivityAnalysisParameters(SensitivityAnalysisParameters sensiParameters) {
    ...
    public OldRaoParameters setMnecAcceptableMarginDiminution(double mnecAcceptableMarginDiminution) {
    ...
    public OldRaoParameters setMnecConstraintAdjustmentCoefficient(double mnecConstraintAdjustmentCoefficient) {
    ...
    public OldRaoParameters setMnecViolationCost(double mnecViolationCost) {
    ...
    public OldRaoParameters setLoopflowCountries(Set<Country> loopflowCountries) {
        this.loopflowCountries = loopflowCountries;
        return this;
    }

    public OldRaoParameters setLoopflowCountries(List<String> countryStrings) {
    ...
    public OldRaoParameters setRelativeMarginPtdfBoundaries(List<ZoneToZonePtdfDefinition> boundaries) {
    ...
    public OldRaoParameters setRelativeMarginPtdfBoundariesFromString(List<String> boundaries) {
    ...
    /**
     * A configuration loader interface for the OldRaoParameters extensions loaded from the platform configuration
     * @param <E> The extension class
     */
    public static interface ConfigLoader<E extends Extension<OldRaoParameters>> extends ExtensionConfigLoader<OldRaoParameters, E> {
    }
    ...
    /**
     * @return OldRaoParameters from platform default config.
     */
    public static OldRaoParameters load() {
        return load(PlatformConfig.defaultConfig());
    }

    /**
     * @param platformConfig PlatformConfig where the OldRaoParameters should be read from
     * @return OldRaoParameters from the provided platform config
     */
    public static OldRaoParameters load(PlatformConfig platformConfig) {
        Objects.requireNonNull(platformConfig);

        OldRaoParameters parameters = new OldRaoParameters();
    ...
    public static void load(OldRaoParameters parameters, PlatformConfig platformConfig) {
