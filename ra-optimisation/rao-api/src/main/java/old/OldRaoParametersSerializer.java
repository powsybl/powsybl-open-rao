 ...
 */
public class OldRaoParametersSerializer extends StdSerializer<OldRaoParameters> {

    OldRaoParametersSerializer() {
        super(OldRaoParameters.class);
    }

    @Override
    public void serialize(OldRaoParameters parameters, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        jsonGenerator.writeStartObject();
        jsonGenerator.writeStringField("version", OldRaoParameters.VERSION);
        ...
        JsonUtil.writeExtensions(parameters, jsonGenerator, serializerProvider, OldJsonRaoParameters.getExtensionSerializers());
