...
public class TopoOptimizationParameters {
    ...
    public static int getMaxPreventiveSearchTreeDepth(RaoParameters parameters) {
        if (parameters.hasExtension(TopoOptimizationParameters.class)) {
            return parameters.getExtension(TopoOptimizationParameters.class).getMaxPreventiveSearchTreeDepth();
        }
    ...
    public static int getMaxAutoSearchTreeDepth(RaoParameters parameters) {
        if (parameters.hasExtension(TopoOptimizationParameters.class)) {
            return parameters.getExtension(TopoOptimizationParameters.class).getMaxAutoSearchTreeDepth();
        }
        return DEFAULT_MAX_SEARCH_TREE_DEPTH;
    }

    public static boolean isSkipActionsFarFromMostLimitingElement(RaoParameters raoParameters) {
        if (raoParameters.hasExtension(com.powsybl.openrao.raoapi.parameters.extensions.TopoOptimizationParameters.class)) {
            return raoParameters.getExtension(com.powsybl.openrao.raoapi.parameters.extensions.TopoOptimizationParameters.class).getSkipActionsFarFromMostLimitingElement();
        }
    ...
    public static int getMaxNumberOfBoundariesForSkippingActions(RaoParameters raoParameters) {
        if (raoParameters.hasExtension(com.powsybl.openrao.raoapi.parameters.extensions.TopoOptimizationParameters.class)) {
            return raoParameters.getExtension(com.powsybl.openrao.raoapi.parameters.extensions.TopoOptimizationParameters.class).getMaxNumberOfBoundariesForSkippingActions();
        }
    ...
    public static List<List<String>> getPredefinedCombinations(RaoParameters raoParameters) {
        if (raoParameters.hasExtension(com.powsybl.openrao.raoapi.parameters.extensions.TopoOptimizationParameters.class)) {
            return raoParameters.getExtension(com.powsybl.openrao.raoapi.parameters.extensions.TopoOptimizationParameters.class).getPredefinedCombinations();
        }
