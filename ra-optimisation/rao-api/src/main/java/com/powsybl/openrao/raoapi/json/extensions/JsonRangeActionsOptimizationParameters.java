...
final class JsonRangeActionsOptimizationParameters {
    ...
    private static OpenRaoSearchTreeParameters.RangeActionsOptimizationParameters.PstModel stringToPstModel(String string) {
        try {
            return OpenRaoSearchTreeParameters.RangeActionsOptimizationParameters.PstModel.valueOf(string);
        } catch (IllegalArgumentException e) {
            throw new OpenRaoException(String.format("Unknown Pst model: %s", string));
        }
    }

    private static OpenRaoSearchTreeParameters.RangeActionsOptimizationParameters.RaRangeShrinking stringToRaRangeShrinking(String string) {
        try {
            return OpenRaoSearchTreeParameters.RangeActionsOptimizationParameters.RaRangeShrinking.valueOf(string);
        } catch (IllegalArgumentException e) {
            throw new OpenRaoException(String.format("Unknown Pst variation range shrinking: %s", string));
        }
    }

    private static OpenRaoSearchTreeParameters.RangeActionsOptimizationParameters.Solver stringToSolver(String string) {
        try {
            return OpenRaoSearchTreeParameters.RangeActionsOptimizationParameters.Solver.valueOf(string);
        } catch (IllegalArgumentException e) {
