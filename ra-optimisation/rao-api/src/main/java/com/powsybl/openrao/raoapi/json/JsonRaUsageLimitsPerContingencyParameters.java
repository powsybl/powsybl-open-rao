 ...
 */
final class JsonRaUsageLimitsPerContingencyParameters {
        ...
        while (!jsonParser.nextToken().isStructEnd()) {
            switch (jsonParser.getCurrentName()) {
                ...
                case MAX_CURATIVE_RA_PER_TSO:
                    ...
                    break;
                default:
                    throw new OpenRaoException(String.format("Cannot deserialize ra usage limits per contingency parameters: unexpected field in %s (%s)", RA_USAGE_LIMITS_PER_CONTINGENCY, jsonParser.getCurrentName()));
            }
        }
    }
