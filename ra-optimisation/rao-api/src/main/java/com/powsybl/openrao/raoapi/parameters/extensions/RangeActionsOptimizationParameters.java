...
public class RangeActionsOptimizationParameters {
    ...
    public static PstModel getPstModel(RaoParameters raoParameters) {
        if (raoParameters.hasExtension(RangeActionsOptimizationParameters.class)) {
            return raoParameters.getExtension(RangeActionsOptimizationParameters.class).getPstModel();
        }
        return DEFAULT_PST_MODEL;
    }

    public static RaRangeShrinking getRaRangeShrinking(RaoParameters parameters) {
        if (parameters.hasExtension(RangeActionsOptimizationParameters.class)) {
            return parameters.getExtension(RangeActionsOptimizationParameters.class).getRaRangeShrinking();
        }
    ...
    public static LinearOptimizationSolver getLinearOptimizationSolver(RaoParameters parameters) {
        if (parameters.hasExtension(RangeActionsOptimizationParameters.class)) {
            return parameters.getExtension(RangeActionsOptimizationParameters.class).getLinearOptimizationSolver();
        }
    ...
    public static int getMaxMipIterations(RaoParameters parameters) {
        if (parameters.hasExtension(RangeActionsOptimizationParameters.class)) {
            return parameters.getExtension(RangeActionsOptimizationParameters.class).getMaxMipIterations();
        }
