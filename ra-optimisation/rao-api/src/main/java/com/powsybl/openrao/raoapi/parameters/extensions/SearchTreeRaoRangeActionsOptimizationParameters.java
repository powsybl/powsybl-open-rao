...
public class SearchTreeRaoRangeActionsOptimizationParameters {
    ...
    private static final double DEFAULT_PST_SENSITIVITY_THRESHOLD = 1e-4;
    private static final PstModel DEFAULT_PST_MODEL = PstModel.CONTINUOUS;
    private static final double DEFAULT_HVDC_SENSITIVITY_THRESHOLD = 1e-4;
    private static final double DEFAULT_INJECTION_RA_SENSITIVITY_THRESHOLD = 1e-4;
