...
public class LoadFlowAndSensitivityParameters {
    ...
    public static String getLoadFlowProvider(RaoParameters raoParameters) {
        if (raoParameters.hasExtension(LoadFlowAndSensitivityParameters.class)) {
            return raoParameters.getExtension(LoadFlowAndSensitivityParameters.class).getLoadFlowProvider();
        }
    ...
    public static double getSensitivityFailureOvercost(RaoParameters raoParameters) {
        if (raoParameters.hasExtension(LoadFlowAndSensitivityParameters.class)) {
            return raoParameters.getExtension(LoadFlowAndSensitivityParameters.class).getSensitivityFailureOvercost();
        }
    ...
    public static String getSensitivityProvider(RaoParameters raoParameters) {
        if (raoParameters.hasExtension(LoadFlowAndSensitivityParameters.class)) {
            return raoParameters.getExtension(LoadFlowAndSensitivityParameters.class).getSensitivityProvider();
        }
    ...
    public static SensitivityAnalysisParameters getSensitivityWithLoadFlowParameters(RaoParameters raoParameters) {
        if (raoParameters.hasExtension(LoadFlowAndSensitivityParameters.class)) {
            return raoParameters.getExtension(LoadFlowAndSensitivityParameters.class).getSensitivityWithLoadFlowParameters();
        }
