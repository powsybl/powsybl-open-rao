...
class BasicMarginEvaluatorTest {
    ...
    void getMargin() {
        ...
        double margin = basicMinMarginEvaluator.getMargin(currentFlowResult, flowCnec, rangeActionResult, sensitivityResult, Unit.MEGAWATT);
    ...
    void getRelativeMargin() {
        ...
        double margin = basicRelativeMarginEvaluator.getMargin(currentFlowResult, flowCnec, rangeActionResult, sensitivityResult, Unit.MEGAWATT);
        assertEquals(200., margin, DOUBLE_TOLERANCE);
    }
}
