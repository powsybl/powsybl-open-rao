...
public class JsonSearchTreeRaoParametersTest extends AbstractConverterTest {
    ...
    public void roundTrip() throws IOException {
        ...
        parameters.getExtension(SearchTreeRaoParameters.class).setUnoptimizedCnecsInSeriesWithPstsIds(Map.of("cnec1", "pst1"));
    ...
    public void update() {
        ...
        assertTrue(extension.getUnoptimizedCnecsInSeriesWithPstsIds().isEmpty());
