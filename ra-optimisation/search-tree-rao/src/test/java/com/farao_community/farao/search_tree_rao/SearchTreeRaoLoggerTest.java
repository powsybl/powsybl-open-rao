...
public class SearchTreeRaoLoggerTest {
    ...
    public void testFormatDouble() {
        ...
        assertEquals("-infinity", SearchTreeRaoLogger.formatDouble(-Double.MAX_VALUE));
        assertEquals("+infinity", SearchTreeRaoLogger.formatDouble(Double.MAX_VALUE));
        assertEquals("-infinity", SearchTreeRaoLogger.formatDouble(-.00));
        assertEquals("+infinity", SearchTreeRaoLogger.formatDouble(.00));
    }
