...
public class CastorTest {
    ...
    public void testComputePerimeterCnecs() {
        assertEquals(Set.of(cnec1), Castor.computePerimeterCnecs(crac, Set.of(state1)));
        assertEquals(Set.of(cnec2), Castor.computePerimeterCnecs(crac, Set.of(state2)));
        assertEquals(Set.of(cnec1, cnec2), Castor.computePerimeterCnecs(crac, Set.of(state1, state2)));
        assertEquals(Set.of(cnec3, cnec4), Castor.computePerimeterCnecs(crac, Set.of(state3)));
        assertEquals(Set.of(cnec2, cnec3, cnec4), Castor.computePerimeterCnecs(crac, Set.of(state2, state3)));
        assertEquals(Set.of(cnec1, cnec2, cnec3, cnec4), Castor.computePerimeterCnecs(crac, null));
    }

    @Test
    public void testCreateObjectiveFunction() {
        ...
        objFun = Castor.createObjectiveFunction(Set.of(cnec1), initialFlowResult, preperimFlowResult, raoParameters, Mockito.mock(LinearOptimizerParameters.class), toolProvider);
    ...
    public void testBuildSearchTreeInput() {
        ...
        SearchTreeInput searchTreeInput = Castor.buildSearchTreeInput(crac,
                network,
                state1,
    ...
    public void testFilterOutGroup() {
        ...
        Castor.removeAlignedRangeActionsWithDifferentInitialSetpoints(rangeActions, prePerimeterResult);
        assertEquals(Set.of(ra1, ra2), rangeActions);
    }
    ...
    public void testShouldRunSecondPreventiveRaoSimple() {
        ...
        assertFalse(Castor.shouldRunSecondPreventiveRao(parameters, null, preventiveResult, curativeResults, null, 0));
        ...
        assertTrue(Castor.shouldRunSecondPreventiveRao(parameters, null, preventiveResult, curativeResults, null, 0));
    ...
    public void testShouldRunSecondPreventiveRaoTime() {
        ...
        // Enough time
        assertTrue(Castor.shouldRunSecondPreventiveRao(parameters, null, preventiveResult, curativeResults, java.time.Instant.now().plusSeconds(200), 100));
        assertTrue(Castor.shouldRunSecondPreventiveRao(parameters, null, preventiveResult, curativeResults, java.time.Instant.now().plusSeconds(200), 199));

        // Not enough time
        assertFalse(Castor.shouldRunSecondPreventiveRao(parameters, null, preventiveResult, curativeResults, java.time.Instant.now().plusSeconds(200), 201));
        assertFalse(Castor.shouldRunSecondPreventiveRao(parameters, null, preventiveResult, curativeResults, java.time.Instant.now().plusSeconds(200), 400));
    }
    ...
    public void testShouldRunSecondPreventiveRaoCostIncrease() {
        ...
        assertFalse(Castor.shouldRunSecondPreventiveRao(parameters, initialResult, preventiveResult, curativeResults, null, 0));

        when(optimizationResult2.getCost()).thenReturn(-100.);
        assertFalse(Castor.shouldRunSecondPreventiveRao(parameters, initialResult, preventiveResult, curativeResults, null, 0));

        when(optimizationResult2.getCost()).thenReturn(-95.);
        assertTrue(Castor.shouldRunSecondPreventiveRao(parameters, initialResult, preventiveResult, curativeResults, null, 0));
    }
    ...
    public void testIsRangeActionAvailableInState() {
        ...
        assertTrue(Castor.isRangeActionAvailableInState(ra1, crac.getPreventiveState(), crac));
        assertFalse(Castor.isRangeActionAvailableInState(ra1, state1, crac));
        assertFalse(Castor.isRangeActionAvailableInState(ra1, state2, crac));

        // ra2 is available in state2 only
        assertFalse(Castor.isRangeActionAvailableInState(ra2, crac.getPreventiveState(), crac));
        assertFalse(Castor.isRangeActionAvailableInState(ra2, state1, crac));
        assertTrue(Castor.isRangeActionAvailableInState(ra2, state2, crac));

        // ra3 is available in preventive and in state1
        assertTrue(Castor.isRangeActionAvailableInState(ra3, crac.getPreventiveState(), crac));
        assertTrue(Castor.isRangeActionAvailableInState(ra3, state1, crac));
        assertFalse(Castor.isRangeActionAvailableInState(ra3, state2, crac));

        // ra4 is preventive, ra5 is available in state2, both have the same network element
        assertTrue(Castor.isRangeActionAvailableInState(ra4, crac.getPreventiveState(), crac));
        assertFalse(Castor.isRangeActionAvailableInState(ra4, state1, crac));
        assertTrue(Castor.isRangeActionAvailableInState(ra4, state2, crac));

        assertTrue(Castor.isRangeActionAvailableInState(ra5, crac.getPreventiveState(), crac));
        assertFalse(Castor.isRangeActionAvailableInState(ra5, state1, crac));
        assertTrue(Castor.isRangeActionAvailableInState(ra5, state2, crac));

        // ra6 is available in preventive and in state1 and in state2
        assertTrue(Castor.isRangeActionAvailableInState(ra6, crac.getPreventiveState(), crac));
        assertTrue(Castor.isRangeActionAvailableInState(ra6, state1, crac));
        assertTrue(Castor.isRangeActionAvailableInState(ra6, state2, crac));
    }
    ...
    public void testIsRangeActionPreventive() {
        setUpCracWithRAs();
        // ra1 is available in preventive only
        assertTrue(Castor.isRangeActionPreventive(ra1, crac));
        // ra2 is available in state2 only
        assertFalse(Castor.isRangeActionPreventive(ra2, crac));
        // ra3 is available in preventive and in state1
        assertTrue(Castor.isRangeActionPreventive(ra3, crac));
        // ra4 is preventive, ra5 is available in state2, both have the same network element
        assertTrue(Castor.isRangeActionPreventive(ra4, crac));
        assertTrue(Castor.isRangeActionPreventive(ra5, crac));
        // ra6 is preventive and curative
        assertTrue(Castor.isRangeActionPreventive(ra6, crac));
    }
    ...
    public void testIsRangeActionCurative() {
        setUpCracWithRAs();
        // ra1 is available in preventive only
        assertFalse(Castor.isRangeActionCurative(ra1, crac));
        // ra2 is available in state2 only
        assertTrue(Castor.isRangeActionCurative(ra2, crac));
        // ra3 is available in preventive and in state1
        assertTrue(Castor.isRangeActionCurative(ra3, crac));
        // ra4 is preventive, ra5 is available in state2, both have the same network element
        assertTrue(Castor.isRangeActionCurative(ra4, crac));
        assertTrue(Castor.isRangeActionCurative(ra5, crac));
        // ra6 is preventive and curative
        assertTrue(Castor.isRangeActionCurative(ra6, crac));
    }
    ...
    public void testGetRangeActionsExcludedFromSecondPreventive() {
        ...
        Set<RangeAction<?>> rangeActionsExcludedFrom2P = Castor.getRangeActionsExcludedFromSecondPreventive(crac);
    ...
    public void testRemoveRangeActionsExcludedFromSecondPreventive() {
        setUpCracWithRAs();
        Set<RangeAction<?>> rangeActions = new HashSet<>(Set.of(ra1, ra2, ra3, ra4, ra5));
        Castor.removeRangeActionsExcludedFromSecondPreventive(rangeActions, crac);
    ...
    public void testBuildSearchTreeInputForSecondPreventive() {
        ...
        assertThrows(NullPointerException.class, () -> Castor.buildSearchTreeInput(crac,
                network,
                preventiveState,
                optimizedStates,
                initialOutput,
    ...
    public void testApplyPreventiveResultsForCurativeRangeActions() {
        ...
        Castor.applyPreventiveResultsForCurativeRangeActions(network, perimeterResult, crac);
    ...
    public void testGetAppliedRemedialActionsInCurative() {
        ...
        AppliedRemedialActions appliedRemedialActions = Castor.getAppliedRemedialActionsInCurative(curativeResults, prePerimeterResult);
