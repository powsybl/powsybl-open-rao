...
public class PerimetersTest {
    ...
    public void testCreatePerimetersWithOneRemedialActionOnOutage() {
        PstRangeAction pstRange = new PstWithRange("pst-ra", crac.addNetworkElement("pst1"));
    ...
    public void testCreatePerimetersWithTwoRemedialActions() {
        PstRangeAction pstRange1 = new PstWithRange("pst-ra1", crac.addNetworkElement("pst1"));
        ...
        PstRangeAction pstRange2 = new PstWithRange("pst-ra2", crac.addNetworkElement("pst1"));
