...
public class MaxLoopFlowFiller implements ProblemFiller {
    ...
    public MaxLoopFlowFiller(Set<FlowCnec> loopFlowCnecs,
        ...
        this.loopFlowCnecs.addAll(com.powsybl.openrao.timecoupledsearchtreerao.linearoptimisation.algorithms.fillers.FillersUtil.getFlowCnecsNotNaNFlow(loopFlowCnecs, initialFlowResult));
