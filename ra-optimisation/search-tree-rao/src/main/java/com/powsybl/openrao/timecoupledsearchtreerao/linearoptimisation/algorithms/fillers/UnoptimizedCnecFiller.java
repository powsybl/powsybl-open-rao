...
public class UnoptimizedCnecFiller implements ProblemFiller {
    ...
    public UnoptimizedCnecFiller(Set<FlowCnec> flowCnecs,
        ...
        this.flowCnecs.addAll(com.powsybl.openrao.timecoupledsearchtreerao.linearoptimisation.algorithms.fillers.FillersUtil.getFlowCnecsNotNaNFlow(flowCnecs, prePerimeterFlowResult));
