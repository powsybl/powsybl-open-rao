...
public class CastorContingencyScenarios {
    ...
    public Map<State, OptimizationResult> optimizeContingencyScenarios(Network network,
        ...
        AutomatonSimulator automatonSimulator = new AutomatonSimulator(crac, raoParameters, toolProvider, initialSensitivityOutput, prePerimeterSensitivityOutput, stateTree.getOperatorsNotSharingCras(), NUMBER_LOGGED_ELEMENTS_DURING_RAO, preventiveResult);
    ...
    private OptimizationResult optimizeCurativePerimeter(Perimeter curativePerimeter,
        ...
        ObjectiveFunction objectiveFunction = ObjectiveFunction.create().build(flowCnecs, loopFlowCnecs, initialSensitivityOutput, prePerimeterSensitivityOutput, stateTree.getOperatorsNotSharingCras(), raoParameters, curativePerimeter.getAllStates());
