...
public class CastorOneStateOnly {
    ...
    public CompletableFuture<RaoResult> run() {
        ...
        if (raoInput.getOptimizedState().getInstant().isAuto()) {
            ...
            AutomatonSimulator automatonSimulator = new AutomatonSimulator(raoInput.getCrac(), raoParameters, toolProvider, initialResults, initialResults, stateTree.getOperatorsNotSharingCras(), 2, null);
            ...
            SearchTreeInput searchTreeInput = SearchTreeInput.create()
                    ...
                    .withObjectiveFunction(ObjectiveFunction.create().build(optPerimeter.getFlowCnecs(), optPerimeter.getLoopFlowCnecs(), initialResults, initialResults, operatorsNotToOptimize, raoParameters, statesToOptimize))
