...
public final class CastorPstRegulation {
    ...
    public static Set<PstRegulationResult> regulatePsts(Map<String, String> pstsToRegulate,
        Map<State, PostPerimeterResult> postContingencyResults, Network network, Crac crac,
    ...
    private static Set<PstRegulationInput> getStatesToRegulate(Crac crac,
        Map<State, PostPerimeterResult> postContingencyResults, Unit unit,
        Set<PstRangeAction> rangeActionsToRegulate, Map<String, String> linesInSeriesWithPst,
        Network network) {
    ...
    private static Optional<PstRegulationInput> getPstRegulationInput(State curativeState,
        ...
        Set<PstRangeAction> rangeActionsToRegulate, Map<String, String> linesInSeriesWithPst,
        Network network) {
        Optional<FlowCnec> limitingElement = getMostLimitingElementProtectedByPst(curativeState,
    ...
    private static Optional<FlowCnec> getMostLimitingElementProtectedByPst(State curativeState,
        ...
        Map<FlowCnec, Double> marginPerCnec = crac.getFlowCnecs(curativeState).stream().collect(
    ...
    private static Set<PstRangeAction> getPstRangeActionsForRegulation(Set<String> pstsToRegulate,
        Crac crac) {
    ...
    private static Map<String, PstRangeAction> getRangeActionPerPst(Set<String> pstsToRegulate,
        Crac crac) {
    ...
    private static PstRegulationResult regulatePstsForContingencyScenario(
        ...
        Set<PstRangeAction> rangeActionsToRegulate, RaoResult raoResult,
        ...
        Map<PstRangeAction, Integer> initialTapPerPst = getInitialTapPerPst(rangeActionsToRegulate,
            networkClone);
    ...
    private static Map<PstRangeAction, Integer> getInitialTapPerPst(
        Set<PstRangeAction> rangeActionsToRegulate, Network networkClone) {
