...
public class MaxLoopFlowFiller implements ProblemFiller {
    ...
    public void fill(LinearProblem linearProblem, PerimeterResultWithCnecs flowAndSensiResult) {
        buildLoopFlowConstraintsAndUpdateObjectiveFunction(linearProblem, getValidLoopFlowCnecs(flowAndSensiResult), flowAndSensiResult);
    }
    ...
    public void updateBetweenSensiIteration(LinearProblem linearProblem, PerimeterResultWithCnecs flowAndSensiResult, MultiStateRemedialActionResultImpl rangeActionResult) {
        updateLoopFlowConstraints(linearProblem, getValidLoopFlowCnecs(flowAndSensiResult), flowAndSensiResult);
    }
