...
import com.powsybl.openrao.searchtreerao.linearoptimisation.algorithms.fillers.GeneratorConstraintFiller;
...
public final class InterTemporalIteratingLinearOptimizer {
    ...
    private static List<ProblemFiller> getInterTemporalProblemFillers(InterTemporalIteratingLinearOptimizerInput input) {
        ...
        return List.of(new GeneratorConstraintFiller(preventiveStates, preventiveInjectionRangeActions, input.generatorConstraints()));
    }
