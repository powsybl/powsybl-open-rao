...
public class MinMarginEvaluator implements CostEvaluator {
    ...
    private List<FlowCnec> getCostlyElements(FlowResult flowResult, RangeActionActivationResult rangeActionActivationResult, Set<String> contingenciesToExclude) {
        ...
        flowCnecs.stream()
            ...
            .forEach(flowCnec -> margins.put(flowCnec, marginEvaluator.getMargin(flowResult, flowCnec, rangeActionActivationResult, unit)));
    ...
    public Pair<Double, List<FlowCnec>> computeCostAndLimitingElements(FlowResult flowResult, RangeActionActivationResult rangeActionActivationResult, ComputationStatus sensitivityStatus, Set<String> contingenciesToExclude) {
        List<FlowCnec> costlyElements = getCostlyElements(flowResult, rangeActionActivationResult, contingenciesToExclude);
        ...
        double margin = marginEvaluator.getMargin(flowResult, limitingElement, rangeActionActivationResult, unit);
