...
import static com.powsybl.openrao.timecoupledsearchtreerao.linearoptimisation.algorithms.linearproblem.LinearProblemIdGenerator.*;
...
public final class LinearProblem {
    ...
    public OpenRaoMPVariable addTotalPstRangeActionTapVariationVariable(PstRangeAction pstRangeAction, State state, VariationDirectionExtension variationDirection) {
        return solver.makeIntVar(0, infinity(), totalPstRangeActionTapVariationVariableId(pstRangeAction, state, variationDirection));
    }

    public OpenRaoMPVariable getTotalPstRangeActionTapVariationVariable(PstRangeAction pstRangeAction, State state, VariationDirectionExtension variationDirection) {
