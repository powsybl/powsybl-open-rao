...
public class CastorOneStateOnly {
    ...
    public CompletableFuture<RaoResult> run() {
        ...
        SearchTreeInput searchTreeInput = SearchTreeInput.create()
            ...
            .withObjectiveFunction(ObjectiveFunction.create().build(optPerimeter.getFlowCnecs(), optPerimeter.getLoopFlowCnecs(), initialResults, initialResults, initialResults, operatorsNotToOptimize, raoParameters))
