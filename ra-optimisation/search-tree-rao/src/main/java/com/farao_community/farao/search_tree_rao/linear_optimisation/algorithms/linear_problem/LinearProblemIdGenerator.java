...
public final class LinearProblemIdGenerator {
    ...
    private static final String DONT_OPTIMIZECNEC = "DontOptimizecnec";
    ...
    public static String dontOptimizeCnecBinaryVariableId(FlowCnec flowCnec, Side side) {
        return String.join(SEPARATOR, flowCnec.getId(), side.toString().toLowerCase(), DONT_OPTIMIZECNEC, VARIABLE_SUFFIX);
    }
    ...
    public static String dontOptimizeCnecConstraintId(FlowCnec flowCnec, Side side, LinearProblem.MarginExtension belowOrAboveThreshold) {
        return String.join(SEPARATOR, flowCnec.getId(), side.toString().toLowerCase(), DONT_OPTIMIZECNEC + belowOrAboveThreshold.toString().toLowerCase(), CONSTRAINT_SUFFIX);
    }
