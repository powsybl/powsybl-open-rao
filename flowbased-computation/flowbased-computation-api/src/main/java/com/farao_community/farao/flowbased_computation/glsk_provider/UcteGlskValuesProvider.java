...
/**
 * FlowBased Glsk Values Provider, for UCTE Glsk format
 *
 * @author Baptiste Seguinot {@literal <baptiste.seguinot at rte-france.com>}
 */
public class UcteGlskValuesProvider extends GlskValuesProvider {
    /**
     * constructor
     */
    public UcteGlskValuesProvider() {
        super();
    }
     ...
     */
    public UcteGlskValuesProvider(Network network, String filePathString) {
    ...
    public Map<String, DataChronology<LinearGlsk> > createDataChronologyLinearGlskMap(Network network, String filePathString) throws FaraoException {
        try {
            return new UcteGlskDocumentLinearGlskConverter().convertUcteGlskDocumentToLinearGlskDataChronologyFromFilePathString(filePathString, network);
