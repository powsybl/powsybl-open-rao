...
/**
 * Flowbased computation implementation with Crac as input
 * Another implementation with CracFile as input is FlowBasedComputationImpl
 *
 * @author Sebastien Murgey {@literal <sebastien.murgey at rte-france.com>}
 */
@AutoService(FlowBasedComputationProvider.class)
public class FlowBasedComputationCracImpl implements FlowBasedComputationProvider {
    private static final Logger LOGGER = LoggerFactory.getLogger(FlowBasedComputationCracImpl.class);
    ...
    public CompletableFuture<FlowBasedComputationResult> run(Network network, CracFile cracFile, GlskProvider glskProvider, ComputationManager computationManager, String workingVariantId, FlowBasedComputationParameters parameters) {
        return null; //this should be refactoring when CracFile class totally replaced by Crac class
    }
