...
import com.farao_community.farao.data.crac_file.xlsx.converter.TypeRaTimesSeriesConverter;
...
public class RaTimeSeries {
    ...
    @ExcelColumn(position = 2, convertorClass = TypeRaTimesSeriesConverter.class)
    private final TypeRaTimesSeries typeRaTimesSeries;
    ...
    public RaTimeSeries(LocalDate date, String raId, TypeRaTimesSeries typeRaTimesSeries, float limit1, float limit2, float limit3, float limit4, float limit5, float limit6, float limit7, float limit8, float limit9, float limit10, float limit11, float limit12, float limit13, float limit14, float limit15, float limit16, float limit17, float limit18, float limit19, float limit20, float limit21, float limit22, float limit23, float limit24) {
        this.date = date;
        this.raId = raId;
        this.typeRaTimesSeries = typeRaTimesSeries;
        this.limit1 = limit1;
        this.limit2 = limit2;
        this.limit3 = limit3;
        this.limit4 = limit4;
    ...
    public String toString() {
        return "RaTimeSeries{" +
                "date=" + date +
                ", raId='" + raId + '\'' +
                ", typeRaTimesSeries=" + typeRaTimesSeries +
                ", limit1=" + limit1 +
                ", limit2=" + limit2 +
                ", limit3=" + limit3 +
                ", limit4=" + limit4 +
