...
import com.farao_community.farao.data.crac_file.xlsx.model.TypeRaTimesSeries;
 ...
 */
@Slf4j
public class TypeRaTimesSeriesConverter implements Converter<TypeRaTimesSeries> {
    @Override
    public TypeRaTimesSeries convert(String value, int row) {
        try {
