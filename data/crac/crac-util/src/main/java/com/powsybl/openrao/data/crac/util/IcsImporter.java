            ...
            if (shouldBeImported(staticRecord, weightPerNodePerGsk)) {
                ...
                if (seriesPerType != null &&
                    ...
                    if (staticRecord.get(RD_DESCRIPTION_MODE).equalsIgnoreCase(NODE)) {
                        ...
                        importGskRedispatchingAction(interTemporalRaoInput, staticRecord, initialNetworks, seriesPerType, raId, weightPerNodePerGsk.get(staticRecord.get(UCT_NODE_OR_GSK_ID)));
                    }
                }
            }
        });
