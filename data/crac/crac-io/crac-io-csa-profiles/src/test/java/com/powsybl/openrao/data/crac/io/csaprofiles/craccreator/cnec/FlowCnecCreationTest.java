...
class FlowCnecCreationTest {
    ...
    void importFlowCnecs() {
        CsaProfileCracCreationContext cracCreationContext = CsaProfileCracCreationTestUtil.getCsaCracCreationContext("/profiles/cnecs/FlowCNECs.zip", CsaProfileCracCreationTestUtil.NETWORK);
        ...
        CsaProfileCracCreationTestUtil.assertFlowCnecEquality(
            ...
            "FFR2AA1  FFR3AA1  1",
            CsaProfileCracCreationTestUtil.CURATIVE_2_INSTANT_ID,
            "contingency-1",
            null,
            null,
            +2500d,
        ...
        CsaProfileCracCreationTestUtil.assertFlowCnecEquality(
            ...
            "FFR2AA1  FFR3AA1  1",
            CsaProfileCracCreationTestUtil.OUTAGE_INSTANT_ID,
            "contingency-1",
            null,
            null,
            +5000d,
        ...
        CsaProfileCracCreationTestUtil.assertFlowCnecEquality(
            ...
            "FFR2AA1  FFR3AA1  1",
            CsaProfileCracCreationTestUtil.AUTO_INSTANT_ID,
            "contingency-2",
            null,
            null,
            +4000d,
        ...
        CsaProfileCracCreationTestUtil.assertFlowCnecEquality(
            ...
            "FFR2AA1  FFR3AA1  1",
            CsaProfileCracCreationTestUtil.CURATIVE_1_INSTANT_ID,
            "contingency-2",
            null,
            null,
            +4000d,
        ...
        CsaProfileCracCreationTestUtil.assertCnecNotImported(cracCreationContext, "assessed-element-8", ImportStatus.NOT_FOR_RAO, "AssessedElement assessed-element-8 ignored because it is not enabled");
        CsaProfileCracCreationTestUtil.assertCnecNotImported(cracCreationContext, "assessed-element-9", ImportStatus.ELEMENT_NOT_FOUND_IN_NETWORK, "AssessedElement assessed-element-9 ignored because the following network element is missing from the network: unknown-equipment");
        CsaProfileCracCreationTestUtil.assertCnecNotImported(cracCreationContext, "assessed-element-10", ImportStatus.INCOMPLETE_DATA, "AssessedElement assessed-element-10 ignored because no ConductingEquipment or OperationalLimit was provided");
        CsaProfileCracCreationTestUtil.assertCnecNotImported(cracCreationContext, "assessed-element-11", ImportStatus.INCONSISTENCY_IN_DATA, "The contingency unknown-contingency linked to the assessed element does not exist in the CRAC");
        CsaProfileCracCreationTestUtil.assertCnecNotImported(cracCreationContext, "assessed-element-11", ImportStatus.NOT_FOR_RAO, "The link between contingency contingency-2 and the assessed element is disabled");
        CsaProfileCracCreationTestUtil.assertCnecNotImported(cracCreationContext, "assessed-element-12", ImportStatus.INCONSISTENCY_IN_DATA, "AssessedElement assessed-element-12 ignored because the assessed element is not in base case and not combinable with contingencies, but no explicit link to a contingency was found");
        CsaProfileCracCreationTestUtil.assertCnecNotImported(cracCreationContext, "assessed-element-13", ImportStatus.INCONSISTENCY_IN_DATA, "AssessedElement assessed-element-13 ignored because the assessed element is not in base case and not combinable with contingencies, but no explicit link to a contingency was found");
        CsaProfileCracCreationTestUtil.assertCnecNotImported(cracCreationContext, "assessed-element-14", ImportStatus.INCONSISTENCY_IN_DATA, "AssessedElement assessed-element-14 ignored because the network element FFR1AA1 _generator is not a branch");

        assertEquals(5, cracCreationContext.getCrac().getRemedialAction("remedial-action-1").getUsageRules().size());

        CsaProfileCracCreationTestUtil.assertHasOnConstraintUsageRule(cracCreationContext, "remedial-action-1", "RTE_AE1 (assessed-element-1) - RTE_CO1 - curative 2 - TWO", cracCreationContext.getCrac().getInstant(CsaProfileCracCreationTestUtil.CURATIVE_1_INSTANT_ID), UsageMethod.FORCED, FlowCnec.class);
        CsaProfileCracCreationTestUtil.assertHasOnConstraintUsageRule(cracCreationContext, "remedial-action-1", "RTE_AE1 (assessed-element-1) - RTE_CO1 - curative 3 - TWO", cracCreationContext.getCrac().getInstant(CsaProfileCracCreationTestUtil.CURATIVE_1_INSTANT_ID), UsageMethod.FORCED, FlowCnec.class);
        CsaProfileCracCreationTestUtil.assertHasOnConstraintUsageRule(cracCreationContext, "remedial-action-1", "RTE_AE1 (assessed-element-1) - RTE_CO1 - curative 2 - TWO", cracCreationContext.getCrac().getInstant(CsaProfileCracCreationTestUtil.CURATIVE_2_INSTANT_ID), UsageMethod.FORCED, FlowCnec.class);
        CsaProfileCracCreationTestUtil.assertHasOnConstraintUsageRule(cracCreationContext, "remedial-action-1", "RTE_AE1 (assessed-element-1) - RTE_CO1 - curative 3 - TWO", cracCreationContext.getCrac().getInstant(CsaProfileCracCreationTestUtil.CURATIVE_2_INSTANT_ID), UsageMethod.FORCED, FlowCnec.class);
        CsaProfileCracCreationTestUtil.assertHasOnConstraintUsageRule(cracCreationContext, "remedial-action-1", "RTE_AE1 (assessed-element-1) - RTE_CO1 - curative 3 - TWO", cracCreationContext.getCrac().getInstant(CsaProfileCracCreationTestUtil.CURATIVE_3_INSTANT_ID), UsageMethod.FORCED, FlowCnec.class);
    ...
    void importFlowCnecsWithFlowReliabilityMargin() {
        CsaProfileCracCreationContext cracCreationContext = CsaProfileCracCreationTestUtil.getCsaCracCreationContext("/profiles/cnecs/FlowCNECsWithFlowReliabilityMargin.zip", CsaProfileCracCreationTestUtil.NETWORK);
    ...
    void testCnecsWithBorders() {
        CsaProfileCracCreationContext cracCreationContext = CsaProfileCracCreationTestUtil.getCsaCracCreationContext("/profiles/cnecs/AssessedElementBorders.zip", CsaProfileCracCreationTestUtil.NETWORK);
