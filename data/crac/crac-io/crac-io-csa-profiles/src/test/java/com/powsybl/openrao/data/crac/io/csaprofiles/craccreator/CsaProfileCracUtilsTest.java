...
class CsaProfileCracUtilsTest {
    ...
    @Test
    void testEicFromUrl() {
        assertEquals("10XES-REE------E", CsaProfileCracUtils.getEicFromUrl("http://energy.referencedata.eu/EIC/10XES-REE------E"));
        assertEquals("10XPT-REN------9", CsaProfileCracUtils.getEicFromUrl("http://energy.referencedata.eu/EIC/10XPT-REN------9"));
        assertEquals("10XFR-RTE------Q", CsaProfileCracUtils.getEicFromUrl("http://energy.referencedata.eu/EIC/10XFR-RTE------Q"));
