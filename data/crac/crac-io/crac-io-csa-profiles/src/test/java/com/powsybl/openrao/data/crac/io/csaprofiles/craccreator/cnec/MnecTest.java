...
class MnecTest {
    ...
    void importOptimizedAndMonitoredAssessedElements() {
        CsaProfileCracCreationContext cracCreationContext = CsaProfileCracCreationTestUtil.getCsaCracCreationContext("/profiles/cnecs/SecuredAndScannedAssessedElements.zip", CsaProfileCracCreationTestUtil.NETWORK);
