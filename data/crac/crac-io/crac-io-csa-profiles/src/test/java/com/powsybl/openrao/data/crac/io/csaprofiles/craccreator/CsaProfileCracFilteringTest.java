...
class CsaProfileCracFilteringTest {
    ...
    void testCracCreatorFiltersOutBadTimeStamps() {
        ListAppender<ILoggingEvent> listAppender = CsaProfileCracCreationTestUtil.getLogs(RaoBusinessWarns.class);
        List<ILoggingEvent> logsList = listAppender.list;

        CsaProfileCracCreationContext context = CsaProfileCracCreationTestUtil.getCsaCracCreationContext("/profiles/ProfilesWithIncoherentTimestamps.zip");
