...
import com.powsybl.openrao.data.crac.io.csaprofiles.craccreator.constants.LimitTypeKind;
import com.powsybl.openrao.data.crac.io.csaprofiles.craccreator.constants.OperationalLimitDirectionKind;
...
import static com.powsybl.openrao.data.crac.io.csaprofiles.craccreator.constants.CsaProfileConstants.CURRENT_LIMIT_POSSIBLE_ALIASES_BY_TYPE_LEFT;
import static com.powsybl.openrao.data.crac.io.csaprofiles.craccreator.constants.CsaProfileConstants.CURRENT_LIMIT_POSSIBLE_ALIASES_BY_TYPE_RIGHT;
import static com.powsybl.openrao.data.crac.io.csaprofiles.craccreator.constants.CsaProfileConstants.CURRENT_LIMIT_POSSIBLE_ALIASES_BY_TYPE_TIE_LINE;

/**
 * @author Thomas Bouquet {@literal <thomas.bouquet at rte-france.com>}
 */
public class FlowCnecCreator extends AbstractCnecCreator {
    private CsaCracCreationParameters csaCracCreationParameters;
    ...
    public FlowCnecCreator(Crac crac, Network network, AssessedElement nativeAssessedElement, CurrentLimit nativeCurrentLimit, Set<Contingency> linkedContingencies, Set<ElementaryCreationContext> csaProfileCnecCreationContexts, String rejectedLinksAssessedElementContingency, CracCreationParameters cracCreationParameters, Map<String, String> borderPerTso, Map<String, String> borderPerEic) {
        ...
        csaCracCreationParameters = cracCreationParameters.getExtension(CsaCracCreationParameters.class);
