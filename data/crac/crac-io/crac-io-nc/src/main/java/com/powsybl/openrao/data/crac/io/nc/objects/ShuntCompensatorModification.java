 ...
 */
public record ShuntCompensatorModification(String mrid, String shuntCompensatorId, String propertyReference, boolean normalEnabled,
                                           String gridStateAlterationRemedialAction,
                                           String gridStateAlterationCollection) implements GridStateAlteration {
