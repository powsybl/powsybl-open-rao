 ...
 */
public record RedispatchRemedialAction(String mrid, String name, String operator, String kind, boolean normalAvailable,
                                       String timeToImplement, boolean isManual) implements IdentifiedObjectWithOperator {
    public static RedispatchRemedialAction fromPropertyBag(PropertyBag propertyBag) {
        return new RedispatchRemedialAction(
            propertyBag.getId(NcConstants.REDISPATCH_REMEDIAL_ACTION),
