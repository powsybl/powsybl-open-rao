...
public class NetworkActionCreator {
    ...
    private boolean addInjectionSetPointFromRotatingMachineAction(Set<StaticPropertyRange> staticPropertyRangesLinkedToRotatingMachineAction,
        ...
        NcCracUtils.checkPropertyReference(remedialActionId, STATIC_PROPERTY_RANGE_STRING, PropertyReference.ROTATING_MACHINE, nativeStaticPropertyRange.propertyReference());
    ...
    private boolean addInjectionSetPointFromShuntCompensatorModification(Set<StaticPropertyRange> staticPropertyRangesLinkedToShuntCompensatorModification,
        ...
        NcCracUtils.checkPropertyReference(remedialActionId, STATIC_PROPERTY_RANGE_STRING, PropertyReference.SHUNT_COMPENSATOR, nativeStaticPropertyRange.propertyReference());
