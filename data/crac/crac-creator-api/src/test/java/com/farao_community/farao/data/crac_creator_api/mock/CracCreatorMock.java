...
import com.farao_community.farao.data.crac_creator_api.CracCreationParameters;
...
public class CracCreatorMock implements CracCreator<NativeCracMock, CracCreationContextMock> {
    ...
    @Override
    public CracCreationContextMock createCrac(NativeCracMock nativeCrac, Network network, OffsetDateTime offsetDateTime, CracCreationParameters parameters) {
