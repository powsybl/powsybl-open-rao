...
/**
 * Specific type of {@link Cnec} that is defined on a branch of the network. It presents the singularity of having
 * two sides that could have different voltage levels and independent {@link BranchThreshold}. These thresholds
 * will limit the physical parameter defined for this {@code BranchCnec}.
 *
...
public interface BranchCnec extends Cnec<BranchCnec> {
    ...
    /**
     * Getter of the {@link BranchThreshold} that limit the physical parameter of this {@code BranchCnec}.
     *
     * @return The set of {@link BranchThreshold} defined on the {@code BranchCnec}.
     */
     ...
     * @param side: The side on which the {@code actualValue} is taken and on which he margin will be computed.
