...
public class PostContingencyStateTest {
    ...
    public void testEquals() {
        PostContingencyState state1 = new PostContingencyState(
            new ContingencyImpl("contingency 1", Collections.singleton(new NetworkElementImpl("network-element-1"))),
            Instant.OUTAGE
        );
    ...
    public void testNotEqualsByContingency() {
        ...
        PostContingencyState state2 = new PostContingencyState(
            new ContingencyImpl("contingency 2", Collections.singleton(new NetworkElementImpl("network-element-1"))),
            Instant.PREVENTIVE
        );
    ...
    public void testNotEqualsByContingencyElements() {
        ...
        PostContingencyState state2 = new PostContingencyState(
            new ContingencyImpl("contingency 1", Collections.singleton(new NetworkElementImpl("network-element-2"))),
            Instant.PREVENTIVE
        );
