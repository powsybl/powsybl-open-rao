...
public final class CommonCracCreation {
    ...
    public static Crac createWithPreventiveAndCurativePstRange() {
        ...
        crac.newPstRangeAction()
            ...
            .newOnContingencyStateUsageRule().withInstant(crac.getInstant(Instant.Kind.CURATIVE)).withContingency("Contingency FR1 FR3").withUsageMethod(UsageMethod.AVAILABLE).add()
            .newTapRange()
            .withRangeType(RangeType.ABSOLUTE)
            .withMinTap(-16)
            .withMaxTap(16)
