...
public final class ExhaustiveCracCreation {
    ...
    public static Crac create(CracFactory cracFactory) {
        ...
        crac.newNetworkAction().withId("pstSetpointRaId")
                ...
                .newOnContingencyStateUsageRule().withUsageMethod(UsageMethod.FORCED).withContingency(contingency1Id).withInstant("curative").add()
                .add();
        ...
        crac.newNetworkAction().withId("complexNetworkActionId")
                ...
                .newOnInstantUsageRule().withUsageMethod(UsageMethod.AVAILABLE).withInstant("preventive").add()
                .newOnContingencyStateUsageRule().withUsageMethod(UsageMethod.FORCED).withInstant("preventive").add()
                .add();
        ...
        crac.newNetworkAction().withId("injectionSetpointRaId")
                ...
                .newOnFlowConstraintUsageRule().withFlowCnec("cnec3autoId").withInstant("auto").add()
                .add();
        ...
        crac.newNetworkAction().withId("switchPairRaId")
                ...
                .newOnContingencyStateUsageRule().withUsageMethod(UsageMethod.AVAILABLE).withContingency(contingency2Id).withInstant("curative").add()
                .add();
        ...
        crac.newPstRangeAction().withId("pstRange2Id")
                ...
                .newTapRange().withRangeType(RangeType.ABSOLUTE).withMinTap(1).withMaxTap(7).add()
                .newTapRange().withRangeType(RangeType.RELATIVE_TO_INITIAL_NETWORK).withMinTap(-3).withMaxTap(3).add()
                .newOnFlowConstraintUsageRule().withInstant("preventive").withFlowCnec("cnec3prevId").add()
                .add();
        ...
        crac.newPstRangeAction().withId("pstRange3Id")
            ...
            .newTapRange().withRangeType(RangeType.ABSOLUTE).withMinTap(1).withMaxTap(7).add()
            .newTapRange().withRangeType(RangeType.RELATIVE_TO_INITIAL_NETWORK).withMinTap(-3).withMaxTap(3).add()
            .newOnAngleConstraintUsageRule().withInstant("curative").withAngleCnec("angleCnecId").add()
            .add();
        ...
        crac.newPstRangeAction().withId("pstRange4Id")
                ...
                .newTapRange().withRangeType(RangeType.ABSOLUTE).withMinTap(1).withMaxTap(7).add()
                .newTapRange().withRangeType(RangeType.RELATIVE_TO_INITIAL_NETWORK).withMinTap(-3).withMaxTap(3).add()
                .newOnVoltageConstraintUsageRule().withInstant("curative").withVoltageCnec("voltageCnecId").add()
                .add();
        ...
        crac.newHvdcRangeAction().withId("hvdcRange1Id")
                ...
                .newOnFlowConstraintInCountryUsageRule().withInstant("preventive").withCountry(Country.FR).add()
                .add();
        ...
        crac.newHvdcRangeAction().withId("hvdcRange2Id")
                ...
                .newOnContingencyStateUsageRule().withContingency("contingency2Id").withInstant("curative").withUsageMethod(UsageMethod.AVAILABLE).add()
                .newOnFlowConstraintUsageRule().withInstant("preventive").withFlowCnec("cnec3curId").add()
                .add();
