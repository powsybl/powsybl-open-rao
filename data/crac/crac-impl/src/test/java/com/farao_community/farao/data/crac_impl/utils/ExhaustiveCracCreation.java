...
public final class ExhaustiveCracCreation {
    ...
    public static Crac create(CracFactory cracFactory) {
        ...
        crac.newNetworkAction().withId("pstSetpointRaId")
            ...
            .newOnInstantUsageRule().withUsageMethod(UsageMethod.AVAILABLE).withInstant(instantPrev).add()
            .newOnContingencyStateUsageRule().withUsageMethod(UsageMethod.FORCED).withContingency(contingency1Id).withInstant(instantCurative).add()
            .add();
        ...
        crac.newNetworkAction().withId("complexNetworkActionId")
            ...
            .newOnInstantUsageRule().withUsageMethod(UsageMethod.AVAILABLE).withInstant(instantPrev).add()
            .newOnContingencyStateUsageRule().withUsageMethod(UsageMethod.FORCED).withInstant(instantPrev).add()
            .add();
        ...
        crac.newNetworkAction().withId("injectionSetpointRaId")
            ...
            .newOnFlowConstraintUsageRule().withFlowCnec("cnec3autoId").withInstant(instantAuto).add()
            .add();
        ...
        crac.newNetworkAction().withId("switchPairRaId")
            ...
            .newOnContingencyStateUsageRule().withUsageMethod(UsageMethod.AVAILABLE).withContingency(contingency2Id).withInstant(instantCurative).add()
            .add();
        ...
        crac.newPstRangeAction().withId("pstRange2Id")
            ...
            .newTapRange().withRangeType(RangeType.ABSOLUTE).withMinTap(1).withMaxTap(7).add()
            .newTapRange().withRangeType(RangeType.RELATIVE_TO_INITIAL_NETWORK).withMinTap(-3).withMaxTap(3).add()
            .newOnFlowConstraintUsageRule().withInstant(instantPrev).withFlowCnec("cnec3prevId").add()
            .add();
        ...
        crac.newPstRangeAction().withId("pstRange3Id")
            ...
            .newTapRange().withRangeType(RangeType.ABSOLUTE).withMinTap(1).withMaxTap(7).add()
            .newTapRange().withRangeType(RangeType.RELATIVE_TO_INITIAL_NETWORK).withMinTap(-3).withMaxTap(3).add()
            .newOnAngleConstraintUsageRule().withInstant(instantCurative).withAngleCnec("angleCnecId").add()
            .add();
        ...
        crac.newPstRangeAction().withId("pstRange4Id")
            ...
            .newTapRange().withRangeType(RangeType.ABSOLUTE).withMinTap(1).withMaxTap(7).add()
            .newTapRange().withRangeType(RangeType.RELATIVE_TO_INITIAL_NETWORK).withMinTap(-3).withMaxTap(3).add()
            .newOnVoltageConstraintUsageRule().withInstant(instantCurative).withVoltageCnec("voltageCnecId").add()
            .add();
        ...
        crac.newHvdcRangeAction().withId("hvdcRange1Id")
            ...
            .newOnFlowConstraintInCountryUsageRule().withInstant(instantPrev).withCountry(Country.FR).add()
            .add();
        ...
        crac.newHvdcRangeAction().withId("hvdcRange2Id")
            ...
            .newRange().withMin(-1000).withMax(1000).add()
            .newOnContingencyStateUsageRule().withContingency("contingency1Id").withInstant(instantCurative).withUsageMethod(UsageMethod.AVAILABLE).add()
            .newOnContingencyStateUsageRule().withContingency("contingency2Id").withInstant(instantCurative).withUsageMethod(UsageMethod.AVAILABLE).add()
            .newOnFlowConstraintUsageRule().withInstant(instantPrev).withFlowCnec("cnec3curId").add()
            .add();
        ...
        crac.newInjectionRangeAction().withId("injectionRange1Id")
            ...
            .newRange().withMin(-1000).withMax(1000).add()
            .newOnFlowConstraintInCountryUsageRule().withInstant(instantCurative).withCountry(Country.ES).add()
            .newOnContingencyStateUsageRule().withContingency("contingency1Id").withInstant(instantCurative).withUsageMethod(UsageMethod.AVAILABLE).add()
            .add();
