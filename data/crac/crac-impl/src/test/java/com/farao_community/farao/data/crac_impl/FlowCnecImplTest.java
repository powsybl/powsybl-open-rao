...
class FlowCnecImplTest {
    ...
    private FlowCnecAdder initPreventiveCnecAdder() {
        return crac.newFlowCnec().withId("line-cnec").withName("line-cnec-name").withNetworkElement("anyNetworkElement").withOperator("FR").withInstant(preventiveInstant).withOptimized(true);
    }
    ...
    void testGetLocation1() {
        ...
        FlowCnec cnec1 = crac.newFlowCnec().withId("cnec-1-id").withNetworkElement("BBE1AA1  BBE2AA1  1").withInstant(preventiveInstant).newThreshold().withUnit(MEGAWATT).withMax(1000.).withSide(Side.LEFT).add().add();

        FlowCnec cnec2 = crac.newFlowCnec().withId("cnec-2-id").withNetworkElement("DDE2AA1  NNL3AA1  1").withInstant(preventiveInstant).newThreshold().withUnit(MEGAWATT).withMax(1000.).withSide(Side.LEFT).add().add();
    ...
    void testIsConnected() {
        ...
        // Branch
        FlowCnec cnec1 = crac.newFlowCnec().withId("cnec-1-id").withNetworkElement("BBE1AA1  BBE2AA1  1").withInstant(preventiveInstant).newThreshold().withUnit(MEGAWATT).withMax(1000.).withSide(LEFT).add().add();
        ...
        // DanglingLine
        FlowCnec cnec2 = crac.newFlowCnec().withId("cnec-2-id").withNetworkElement("DL1").withInstant(preventiveInstant).newThreshold().withUnit(MEGAWATT).withMax(1000.).withSide(LEFT).add().add();
        ...
        // Generator
        FlowCnec cnec3 = crac.newFlowCnec().withId("cnec-3-id").withNetworkElement("BBE2AA1 _generator").withInstant(preventiveInstant).newThreshold().withUnit(MEGAWATT).withMax(1000.).withSide(LEFT).add().add();
