    ...
    public UcteGlskPoint(Element element, String ucteBlockType, String area, String ucteBusinessType, Double shareFactor) {
        ...
        switch (ucteBlockType) {
            case "CountryGSK_Block": {
                ...
                CimGlskShiftKey countryGlskShiftKey = new CimGlskShiftKey("B42", ucteBusinessType, this.subjectDomainmRID, this.pointInterval, shareFactor);
                glskShiftKeys.add(countryGlskShiftKey);
                break;
            }
            case "ManualGSK_Block": {
                //build a B43 participation factor
                CimGlskShiftKey manuelGlskShiftKey = new CimGlskShiftKey("B43", ucteBusinessType, this.subjectDomainmRID, this.pointInterval, shareFactor);
            ...
            case "AutoGSK_Block": {
                ...
                CimGlskShiftKey autoGlskShiftKey = new CimGlskShiftKey("B42", ucteBusinessType, this.subjectDomainmRID, this.pointInterval, shareFactor);
                List<AbstractGlskRegisteredResource> registerdResourceArrayList = new ArrayList<>();
