...
class FbConstraintCracCreatorTest {
    ...
    private void addFbConstraintExtension(OffsetDateTime offsetDateTime) {
        if (parameters.getExtension(FbConstraintCracCreationParameters.class) == null) {
            FbConstraintCracCreationParameters fbConstraintParameters = new FbConstraintCracCreationParameters();
            parameters.addExtension(FbConstraintCracCreationParameters.class, fbConstraintParameters);
        }
        parameters.getExtension(FbConstraintCracCreationParameters.class).setOffsetDateTime(offsetDateTime);
    }

    private void addFbConstraintExtension(String timestamp) {
        addFbConstraintExtension(OffsetDateTime.parse(timestamp));
    }
    ...
    void importCracWithParameters() throws IOException {
        ...
        addFbConstraintExtension(timestamp);
