...
public class PstRangeActionCreator {
    ...
    public void createPstRangeActionAdder(CimCracCreationParameters cimCracCreationParameters) {
        ...
        try {
            ...
            RemedialActionSeriesCreator.addUsageRules(applicationModeMarketObjectStatus, pstRangeActionAdder, contingencies, invalidContingencies, flowCnecs, angleCnec, sharedDomain, crac);
