...
import com.powsybl.openrao.data.craccreation.util.CnecElementHelper;
import com.powsybl.iidm.network.*;

import java.util.Objects;
import java.util.Optional;

import static com.powsybl.openrao.data.craccreation.util.ucte.UcteConnectable.Side.TWO;
