...
public class CsaProfileCracCreatorTest {
    ...
    public void testCreateCracTestConfigurationTC1v29Mar2023() {
        ...
        assertEquals("10X1001A1001A361_CO1", c1.getName());
        ...
        assertEquals("10X1001A1001A094_CO1", c2.getName());
    ...
    public void testCreateCracCSATestConfigurationTC2Draftv14Apr2023() {
        ...
        assertEquals("10XFR-RTE------Q_CO1", c1.getName());
        assertEquals(1, c1.getNetworkElements().size());
        Iterator<NetworkElement> it1 = c1.getNetworkElements().iterator();
        ...
        assertEquals("10XES-REE------E_CO4", c2.getName());
        ...
        assertEquals("10XFR-RTE------Q_CO4", c3.getName());
        ...
        assertEquals("10XES-REE------E_CO3", c4.getName());
        ...
        assertEquals("10X1001A1001A361_CO3", c5.getName());
        ...
        assertEquals("10XES-REE------E_CO5", c6.getName());
        ...
        assertEquals("e9eab3fe-c328-4f78-9bc1-77adb59f6ba7", c7.getId());
        assertEquals("10X1001A1001A094_CO1", c7.getName());
        assertEquals(1, c7.getNetworkElements().size());
        Iterator<NetworkElement> it7 = c7.getNetworkElements().iterator();
        assertEquals("dad02278-bd25-476f-8f58-dbe44be72586 + ed0c5d75-4a54-43c8-b782-b20d7431630b", it7.next().getId());

        Contingency c8 = it.next();
        assertEquals("b6b780cb-9fe5-4c45-989d-447a927c3874", c8.getId());
        assertEquals("10XES-REE------E_CO2", c8.getName());
        assertEquals(1, c8.getNetworkElements().size());
        Iterator<NetworkElement> it8 = c8.getNetworkElements().iterator();
        assertEquals("048481d0-c766-11e1-8775-005056c00008", it8.next().getId());

        Contingency c9 = it.next();
        assertEquals("5d587c7e-9ced-416a-ad17-6ef9b241a998", c9.getId());
        assertEquals("10XFR-RTE------Q_CO3", c9.getName());
        ...
        assertEquals("10XES-REE------E_CO1", c10.getName());
        ...
        assertEquals("10XFR-RTE------Q_CO5", c11.getName());
        ...
        assertEquals("10X1001A1001A094_CO2", c12.getName());
        ...
        assertEquals("10X1001A1001A094_CO3", c13.getName());
        ...
        assertEquals("10XFR-RTE------Q_CO6", c14.getName());
        ...
        assertEquals("10XFR-RTE------Q_CO2", c15.getName());
