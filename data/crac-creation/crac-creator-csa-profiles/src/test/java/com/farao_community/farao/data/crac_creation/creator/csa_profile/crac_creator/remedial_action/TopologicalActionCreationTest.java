...
import com.powsybl.open_rao.data.crac_api.network_action.TopologicalAction;
...
import static com.powsybl.open_rao.data.crac_creation.creator.csa_profile.crac_creator.CsaProfileCracCreationTestUtil.*;
...
class TopologicalActionCreationTest {
    ...
    void testTC2ImportNetworkActions() {
        ...
        assertEquals(preventiveInstant, ra17.getUsageRules().iterator().next().getInstant());
        ...
        assertEquals(preventiveInstant, ra11.getUsageRules().iterator().next().getInstant());
        ...
        assertEquals(preventiveInstant, ra2.getUsageRules().iterator().next().getInstant());
    ...
    void testImportNetworkActions() {
        ...
        assertHasOnContingencyStateUsageRule(cracCreationContext, "on-contingency-state-included-curative-topological-remedial-action", "bbda9fe0-77e0-4f8e-b9d9-4402a539f2b7", curativeInstant, UsageMethod.FORCED);
