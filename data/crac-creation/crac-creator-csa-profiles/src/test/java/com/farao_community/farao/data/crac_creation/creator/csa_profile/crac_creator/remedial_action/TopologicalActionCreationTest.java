...
class TopologicalActionCreationTest {
    ...
    void testImportNetworkActions() {
        ...
        assertHasOnContingencyStateUsageRule(cracCreationContext, "on-contingency-state-included-curative-topological-remedial-action", "bbda9fe0-77e0-4f8e-b9d9-4402a539f2b7", CURATIVE, UsageMethod.AVAILABLE);
