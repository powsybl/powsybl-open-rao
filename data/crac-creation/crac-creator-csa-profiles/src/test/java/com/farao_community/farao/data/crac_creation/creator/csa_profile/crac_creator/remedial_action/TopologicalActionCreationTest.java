...
class TopologicalActionCreationTest {
    ...
    void testTC2ImportNetworkActions() {
        ...
        assertEquals(PREVENTIVE_INSTANT_ID, ra17.getUsageRules().iterator().next().getInstant().getId());
        ...
        assertEquals(PREVENTIVE_INSTANT_ID, ra11.getUsageRules().iterator().next().getInstant().getId());
        ...
        assertEquals(PREVENTIVE_INSTANT_ID, ra2.getUsageRules().iterator().next().getInstant().getId());
        ...
        assertEquals(CURATIVE_INSTANT_ID, ra13.getUsageRules().iterator().next().getInstant().getId());
        ...
        assertEquals(CURATIVE_INSTANT_ID, ra22.getUsageRules().iterator().next().getInstant().getId());
        ...
        assertEquals(CURATIVE_INSTANT_ID, ra14.getUsageRules().iterator().next().getInstant().getId());
        ...
        assertEquals(CURATIVE_INSTANT_ID, ra21.getUsageRules().iterator().next().getInstant().getId());
        ...
        assertEquals(CURATIVE_INSTANT_ID, ra5.getUsageRules().iterator().next().getInstant().getId());
    ...
    void testImportNetworkActions() {
        ...
        assertHasOnInstantUsageRule(cracCreationContext, "on-instant-preventive-topological-remedial-action", PREVENTIVE_INSTANT_ID, UsageMethod.AVAILABLE);
        ...
        assertHasOnInstantUsageRule(cracCreationContext, "on-instant-curative-topological-remedial-action", CURATIVE_INSTANT_ID, UsageMethod.AVAILABLE);
        ...
        assertHasOnContingencyStateUsageRule(cracCreationContext, "on-contingency-state-considered-curative-topological-remedial-action", "bbda9fe0-77e0-4f8e-b9d9-4402a539f2b7", CURATIVE_INSTANT_ID, UsageMethod.AVAILABLE);
        ...
        assertHasOnContingencyStateUsageRule(cracCreationContext, "on-contingency-state-included-curative-topological-remedial-action", "bbda9fe0-77e0-4f8e-b9d9-4402a539f2b7", CURATIVE_INSTANT_ID, UsageMethod.FORCED);
        ...
        assertHasOnInstantUsageRule(cracCreationContext, "topological-remedial-action-with-tso-name", PREVENTIVE_INSTANT_ID, UsageMethod.AVAILABLE);
        ...
        assertHasOnInstantUsageRule(cracCreationContext, "nameless-topological-remedial-action-with-tso-name-parent", PREVENTIVE_INSTANT_ID, UsageMethod.AVAILABLE);
    }
