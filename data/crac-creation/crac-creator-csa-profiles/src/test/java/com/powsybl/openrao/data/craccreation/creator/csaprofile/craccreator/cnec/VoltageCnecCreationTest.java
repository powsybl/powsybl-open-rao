...
class VoltageCnecCreationTest {
    ...
    void importVoltageCnecs() {
        ...
        assertEquals(7, cracCreationContext.getCnecCreationContexts().stream().filter(context -> !context.isImported()).toList().size());
        ...
        assertCnecNotImported(cracCreationContext, "assessed-element-8", ImportStatus.INCONSISTENCY_IN_DATA, "AssessedElement assessed-element-8 ignored because its associated OperationalLimitSet has both an equipment and a terminal defined, this is illegal");
        assertCnecNotImported(cracCreationContext, "assessed-element-9", ImportStatus.INCONSISTENCY_IN_DATA, "AssessedElement assessed-element-9 ignored because its associated OperationalLimitSet has no equipment or terminal defined");
