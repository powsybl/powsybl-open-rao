...
class AutoRemedialActionTest {
    ...
    void importAutoRemedialActions() {
        ...
        assertRaNotImported(cracCreationContext, "sps-without-contingency", ImportStatus.INCONSISTENCY_IN_DATA, "Remedial action sps-without-contingency will not be imported because no contingency or assessed element is linked to the remedial action");
    }
}
