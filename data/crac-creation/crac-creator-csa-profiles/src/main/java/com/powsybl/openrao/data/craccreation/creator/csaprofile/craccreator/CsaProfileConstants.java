...
public final class CsaProfileConstants {
    ...
    public enum OverridingObjectsFields {
        ...
        GRID_STATE_ALTERATION("gridStateAlterationOverriding", CsaProfileConstants.GRID_STATE_ALTERATION, NORMAL_ENABLED, OVERRIDE_ENABLED, HeaderType.START_END_DATE),
        ...
        VOLTAGE_ANGLE_LIMIT("voltageAngleLimitOverriding", REQUEST_VOLTAGE_LIMIT, NORMAL_VALUE, OVERRIDE_VALUE, HeaderType.START_END_DATE),
