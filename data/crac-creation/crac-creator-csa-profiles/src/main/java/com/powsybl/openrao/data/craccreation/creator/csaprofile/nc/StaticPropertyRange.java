 ...
 */
public record StaticPropertyRange(String identifier, double normalValue, String valueKind, String direction, String gridStateAlteration, String propertyReference) {
