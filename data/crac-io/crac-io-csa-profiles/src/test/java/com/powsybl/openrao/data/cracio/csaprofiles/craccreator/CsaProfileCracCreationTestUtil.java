...
public final class CsaProfileCracCreationTestUtil {
    ...
    public static CracCreationParameters cracCreationDefaultParametersWithSweCsaExtension() {
        ...
        cracCreationParameters.getExtension(CsaCracCreationParameters.class).setCurativeBatchPostOutageTime(Map.of("curative 1", 300, "curative 2", 600, "curative 3", 1200));
