...
class TopologicalActionCreationTest {
    ...
    void importTopologicalActions() {
        ...
        assertRaNotImported(cracCreationContext, "remedial-action-7", ImportStatus.INCONSISTENCY_IN_DATA, "Remedial action remedial-action-7 will not be imported because the RelativeDirectionKind is RelativeDirectionKind.up but should be absolute");
        assertRaNotImported(cracCreationContext, "remedial-action-8", ImportStatus.INCONSISTENCY_IN_DATA, "Remedial action remedial-action-8 will not be imported because the ValueOffsetKind is ValueOffsetKind.incrementalPercentage but should be none");
