...
class CsaProfileSsiTest {
    ...
    void activateDeactivateRemedialActionDependency() {
        // General case
        cracCreationContext = getCsaCracCreationContext("/profiles/ssi/SSI-17_RemedialActionDependency.zip", NETWORK, "2023-01-01T22:30Z");
        ...
        // With SSI
        cracCreationContext = getCsaCracCreationContext("/profiles/ssi/SSI-17_RemedialActionDependency.zip", NETWORK, "2024-01-31T12:30Z");
    ...
    void overrideRemedialActionGroup() {
        // General case
        cracCreationContext = getCsaCracCreationContext("/profiles/ssi/SSI-18_RemedialActionGroup.zip", NETWORK, "2023-01-01T22:30Z");
        ...
        // With SSI 1
        cracCreationContext = getCsaCracCreationContext("/profiles/ssi/SSI-18_RemedialActionGroup.zip", NETWORK, "2024-01-31T12:30Z");
        ...
        assertEquals("Remedial action group remedial-action-group will not be imported because the remedial action open-be1-be4 does not exist or not imported. All RA's depending in that group will be ignored: open-be1-be4, open-de3-de4",
            cracCreationContext.getRemedialActionCreationContext("remedial-action-group").getImportStatusDetail());
        // With SSI 2
        cracCreationContext = getCsaCracCreationContext("/profiles/ssi/SSI-18_RemedialActionGroup.zip", NETWORK, "2024-02-01T12:30Z");
        ...
        // With SSI 3
        cracCreationContext = getCsaCracCreationContext("/profiles/ssi/SSI-18_RemedialActionGroup.zip", NETWORK, "2024-02-02T12:30Z");
