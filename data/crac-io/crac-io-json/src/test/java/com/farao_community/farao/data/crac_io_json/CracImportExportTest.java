...
class CracImportExportTest {
    ...
    void roundTripTest() {
        ...
        Instant preventiveInstant = crac.getInstant(Kind.PREVENTIVE);
        Instant autoInstant = crac.getInstant(Instant.Kind.AUTO);
        Instant curativeInstant = crac.getInstant(Instant.Kind.CURATIVE);
