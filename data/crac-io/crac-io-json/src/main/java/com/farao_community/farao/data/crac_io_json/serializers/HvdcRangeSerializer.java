 ...
 */
public class HvdcRangeSerializer extends AbstractJsonSerializer<HvdcRange> {
    @Override
    public void serialize(HvdcRange value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
