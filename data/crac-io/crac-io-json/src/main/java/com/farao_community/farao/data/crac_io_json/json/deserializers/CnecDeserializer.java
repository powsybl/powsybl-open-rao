...
final class CnecDeserializer {
    ...
    static void deserialize(JsonParser jsonParser, DeserializationContext deserializationContext, CracImpl simpleCrac) throws IOException {
                ...
                switch (jsonParser.getCurrentName()) {
                    ...
                    case TYPE:
                        if (!jsonParser.nextTextValue().equals(FLOW_CNEC_TYPE)) {
                            throw new FaraoException(format("CracImpl cannot deserialize other Cnecs types than %s", FLOW_CNEC_TYPE));
                        }
                        break;
