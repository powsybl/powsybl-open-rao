...
public final class JsonSerializationConstants {
    ...
    v2.3: addition of RELATIVE_TO_PREVIOUS_TIMESTAMP RangeType
     */
    ...
    public static final String RELATIVE_TO_PREVIOUS_TIMESTAMP = "relativeToPreviousTimestamp";
    ...
    public static String serializeRangeType(RangeType rangeType) {
        switch (rangeType) {
            ...
            case RELATIVE_TO_PREVIOUS_TIMESTAMP:
                return RELATIVE_TO_PREVIOUS_TIMESTAMP;
            default:
    ...
    public static RangeType deserializeRangeType(String stringValue) {
        switch (stringValue) {
            ...
            case RELATIVE_TO_PREVIOUS_TIMESTAMP:
                return RangeType.RELATIVE_TO_PREVIOUS_TIMESTAMP;
            default:
