...
import static com.powsybl.openrao.data.craciojson.JsonSerializationConstants.MAX_PST_PER_TSO;
import static com.powsybl.openrao.data.craciojson.JsonSerializationConstants.MAX_RA_PER_TSO;
import static com.powsybl.openrao.data.craciojson.JsonSerializationConstants.RA_USAGE_LIMITS_PER_INSTANT;
...
public final class RaUsageLimitsDeserializer {
    ...
    public static void deserialize(JsonParser jsonParser, Crac crac, ReportNode reportNode) throws IOException {
        while (jsonParser.nextToken() != JsonToken.END_ARRAY) {
            Pair<String, RaUsageLimits> raUsageLimitsPair = deserializeRaUsageLimits(jsonParser, reportNode);
    ...
    public static Pair<String, RaUsageLimits> deserializeRaUsageLimits(JsonParser jsonParser, ReportNode reportNode) throws IOException {
