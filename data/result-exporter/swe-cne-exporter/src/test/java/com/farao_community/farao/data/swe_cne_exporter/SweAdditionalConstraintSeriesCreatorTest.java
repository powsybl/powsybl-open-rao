...
public class SweAdditionalConstraintSeriesCreatorTest {
    ...
    private SweAdditionalConstraintSeriesCreator setUpAngleCnecs(Contingency contingency) {
        ...
        Mockito.when(angleMonitoringResult.getAngle(angleCnec1, Unit.DEGREE)).thenReturn(1.34);
    ...
    public void generatePreventiveAdditionalConstraintSeriesTest() {
        ...
        Mockito.when(crac.getAngleCnec(accPrev.getNativeId())).thenReturn(angleCnecPrev);
    ...
    public void generateWrongPostContingencyAdditionalConstraintSeriesTest() {
        ...
        Mockito.when(crac.getAngleCnec(accOutage.getNativeId())).thenReturn(angleCnecOutage);
        Mockito.when(crac.getAngleCnec(accAuto.getNativeId())).thenReturn(angleCnecAuto);
    ...
    public void generateContingencyAdditionalConstraintSeriesTest() {
        ...
        assertEquals(1.34, contingencyAngleSeries.get(0).getQuantityQuantity().doubleValue(), 1.0E-6);
