...
class VirtualHubAssignerTest {
    ...
    void testAssignerOnRealNode() {
        virtualHubs.add(new VirtualHub("code_vh1", "eic_vh1", true, "NNL2AA1 ", new MarketArea("NL", "eic_nl", true), null));
    ...
    void testAssignerOnXNode() {
        virtualHubs.add(new VirtualHub("code_vh2", "eic_vh2", true, "X_GBFR1 ", new MarketArea("FR", "eic_fr", true), null));
        new VirtualHubAssigner(virtualHubs).addVirtualLoads(network);
    ...
    void testAssignerOnNonExistingNode() {
        virtualHubs.add(new VirtualHub("code_vh3", "eic_vh3", true, "UNKNOWN_", new MarketArea("FR", "eic_fr", true), null));
