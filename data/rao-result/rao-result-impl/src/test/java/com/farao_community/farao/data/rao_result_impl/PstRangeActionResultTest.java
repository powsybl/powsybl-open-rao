...
public class PstRangeActionResultTest {
    ...
    public void pstActivatedInPreventiveAndAutoAndCurative() {
        ...
        pstRangeActionResult.setPostPraSetpoint(0.33);
        pstRangeActionResult.addActivationForState(crac.getPreventiveState(), 16, 1.6);
        pstRangeActionResult.addPostAraResult(crac.getState("Contingency FR1 FR2", AUTO), -10, -1.0);
        pstRangeActionResult.addActivationForState(crac.getState("Contingency FR1 FR2", CURATIVE), -16, -1.6);
        ...
        // auto state
        assertEquals(16, pstRangeActionResult.getPreOptimizedTapOnState(crac.getState("Contingency FR1 FR2", AUTO)));
        assertEquals(1.6, pstRangeActionResult.getPreOptimizedSetpointOnState(crac.getState("Contingency FR1 FR2", AUTO)), 1e-3);
        assertEquals(-10, pstRangeActionResult.getOptimizedTapOnState(crac.getState("Contingency FR1 FR2", AUTO)));
        assertEquals(-1.0, pstRangeActionResult.getOptimizedSetpointOnState(crac.getState("Contingency FR1 FR2", AUTO)), 1e-3);

        // curative state
        assertEquals(-10, pstRangeActionResult.getPreOptimizedTapOnState(crac.getState("Contingency FR1 FR2", CURATIVE)));
        assertEquals(-1.0, pstRangeActionResult.getPreOptimizedSetpointOnState(crac.getState("Contingency FR1 FR2", CURATIVE)), 1e-3);
        assertEquals(-16, pstRangeActionResult.getOptimizedTapOnState(crac.getState("Contingency FR1 FR2", CURATIVE)));
        assertEquals(-1.6, pstRangeActionResult.getOptimizedSetpointOnState(crac.getState("Contingency FR1 FR2", CURATIVE)), 1e-3);
