...
class SweCneDivergentAngleMonitoringTest {
    ...
    void testExport() throws IOException {
        ...
        try (InputStream is = getClass().getResourceAsStream("/CIM_CRAC.xml")) {
            ...
            RaoResultWithAngleMonitoring raoResultWithAngleMonitoring;
            try (InputStream inputStream = new FileInputStream(SweCneDivergentAngleMonitoringTest.class.getResource("/RaoResult.json").getFile())) {
            ...
            try (InputStream expectedCneInputStream = new FileInputStream(SweCneDivergentAngleMonitoringTest.class.getResource("/SweCNEDivergentAngleMonitoring_Z01.xml").getFile())) {
