...
import com.powsybl.openrao.data.raoresult.io.cne.swe.xsd.AreaIDString;
import com.powsybl.openrao.data.raoresult.io.cne.swe.xsd.ESMPDateTimeInterval;
import com.powsybl.openrao.data.raoresult.io.cne.swe.xsd.PartyIDString;
import com.powsybl.openrao.data.raoresult.io.cne.swe.xsd.ResourceIDString;
...
public final class SweCneUtil {
    ...
    public static int DEFAULT_DECIMALS_FOR_ROUNDING_ANGLES = 1;
    public static int DEFAULT_DECIMALS_FOR_ROUNDING_FLOWS = 1;
    public static int DEFAULT_DECIMALS_FOR_ROUNDING_THRESHOLDS = 0;
