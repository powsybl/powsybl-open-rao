 ...
 */
public interface VoltageCnecDataCalculator extends CnecDataCalculator<VoltageCnec> {
    /**
     ...
     * @return the min voltage of the CNEC in the network
     */
    Double computeMinVoltage(VoltageCnec voltageCnec, Network network, Unit unit);

    /**
     * @param voltageCnec: the voltage CNEC we seek to compute the max voltage of
     * @param network: the network object used to look for actual result of the Cnec
     * @param unit: the unit object used to look for the kind of the {@link Cnec} and the kind of the {@link CnecValue}
     * @return the max voltage of the CNEC in the network
     */
    Double computeMaxVoltage(VoltageCnec voltageCnec, Network network, Unit unit);
}
