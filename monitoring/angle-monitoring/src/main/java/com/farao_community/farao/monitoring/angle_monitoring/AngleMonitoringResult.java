...
public class AngleMonitoringResult {
    ...
    public double getAngle(AngleCnec angleCnec, Unit unit) {
        ...
        if (angles.isEmpty()) {
            ...
            throw new FaraoException(String.format("AngleMonitoringResult was defined %s times with AngleCnec %s and state %s", angles.size(), angleCnec, angleCnec.getState().getId()));
        } else {
