...
Feature: 2.5.2: Handle combined RAs by configuration
  # TODO: This feature covers

  @fast @rao @ac @preventive-only @max-min-margin
  Scenario: 2.5.2.1: Optimal combination in preventive, at first depth
    ...
    Then the worst margin is 97 A
    Then the margin on cnec "be2_fr3_n - BBE2AA1 ->FFR3AA1  - preventive" after PRA should be 97 A
    Then the margin on cnec "fr1_fr4_co1 - FFR1AA1 ->FFR4AA1   - co1_fr2_fr3_1 - curative" after CRA should be 152 A
  ...
  Scenario: 2.5.2.2: Optimal combination in curative, at first depth
    ...
    Then the worst margin is -309 A
  ...
  @fast @rao @ac @contingency-scenarios @max-min-margin
  Scenario: 2.5.2.3: Optimal combination in curative, but not available as only 2 CRA are allowed
    Given network file is "epic15/TestCase16Nodes_ep15us13case2_3_4.uct"
    Given crac file is "epic15/CseCrac_ep15us13case2_3_4.xml"
    Given configuration file is "epic15/RaoParameters_ep15us13case2.json"
  ...
  @fast @rao @ac @contingency-scenarios @max-min-margin
  Scenario: 2.5.2.4: Optimal combination in curative, but not available as only the RA of 1 TSO can be used
    Given network file is "epic15/TestCase16Nodes_ep15us13case2_3_4.uct"
    Given crac file is "epic15/CseCrac_ep15us13case2_3_4.xml"
    Given configuration file is "epic15/RaoParameters_ep15us13case2.json"
  ...
  Scenario: 2.5.2.8: Combination is better than individuals
    ...
    Then the remedial action "open_fr1_fr3" is used in preventive
    Then the remedial action "open_be1_be4" is used in preventive
    Then the worst margin is -77 A
    Then the margin on cnec "be2_fr3_n - BBE2AA1 ->FFR3AA1  - preventive" after PRA should be -77 A
    Then the margin on cnec "be2_fr3_co1 - BBE2AA1 ->FFR3AA1   - co1_fr2_fr3_1 - curative" after CRA should be 106 A
  ...
  Scenario: 2.5.2.9: onConstraint remedial action is not re evaluated after the activation of a combination of RA
    ...
    Then the worst margin is 97 A
    Then the margin on cnec "be2_fr3_n - BBE2AA1 ->FFR3AA1  - preventive" after PRA should be 97 A
    Then the margin on cnec "fr1_fr4_co1 - FFR1AA1 ->FFR4AA1   - co1_fr2_fr3_1 - curative" after CRA should be 102 A
    Then the margin on cnec "fr2_de3_n - FFR2AA1 ->DDE3AA1  - preventive" after PRA should be 272 A
    Then the margin on cnec "be2_fr3_co1 - BBE2AA1 ->FFR3AA1   - co1_fr2_fr3_1 - curative" after CRA should be 311 A
  ...
  Scenario: 2.5.2.10: not imported combinations of RA
    ...
    Then the margin on cnec "be2_fr3_n - BBE2AA1 ->FFR3AA1  - preventive" after PRA should be -44 A
    Then the margin on cnec "fr1_fr4_co1 - FFR1AA1 ->FFR4AA1   - co1_fr2_fr3_1 - curative" after CRA should be -41 A
