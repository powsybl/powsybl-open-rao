...
Feature: US 11.6: Handle mnecs in rao with a cse crac
  ...
  Scenario: US 11.6.1: only network actions - ref run, no mnec
    ...
    And the margin on cnec "critical_branch - NNL2AA1 ->NNL3AA1  - preventive" after PRA should be 759.43 A
    And the value of the objective function after PRA should be -759.43
  ...
  Scenario: US 11.6.2: only network actions - one unconstrained mnec
    ...
    And the remedial action "topo_remedial_action" is used in preventive
    And the margin on cnec "critical_branch - NNL2AA1 ->NNL3AA1  - preventive" after PRA should be 759.43 A
    And the margin on cnec "monitored_element - FFR2AA1 ->DDE3AA1  - preventive" after PRA should be 1380.43 A
    And the value of the objective function after PRA should be -759.43
  ...
  Scenario: US 11.6.3: only network actions - one constrained mnec
    ...
    And the value of the objective function initially should be 203.35
    And the remedial action "topo_remedial_action" is not used in preventive
    And the margin on cnec "critical_branch - NNL2AA1 ->NNL3AA1  - preventive" after PRA should be -203.35 A
    And the margin on cnec "monitored_element - FFR2AA1 ->DDE3AA1  - preventive" after PRA should be 1432.87 A
    And the value of the objective function after PRA should be 203.35
  ...
  Scenario: US 11.6.4: pst range action - reference run, no mnec
    ...
    And the tap of PstRangeAction "PST_pst_remedial_action_BBE2AA1  BBE3AA1  1" should be 16 in preventive
    And the margin on cnec "critical_branch - BBE2AA1 ->BBE3AA1  - preventive" after PRA should be 840.47 A
    And the value of the objective function after PRA should be -840.47
  ...
  Scenario: US 11.6.5: pst range action - one unconstrained mnec
    ...
    And the tap of PstRangeAction "PST_pst_remedial_action_BBE2AA1  BBE3AA1  1" should be 16 in preventive
    And the margin on cnec "critical_branch - BBE2AA1 ->BBE3AA1  - preventive" after PRA should be 840.47 A
    And the margin on cnec "monitored_element - BBE1AA1 ->BBE3AA1  - preventive" after PRA should be 88.00 A
    And the value of the objective function after PRA should be -840.47
  ...
  Scenario: US 11.6.6: pst range action - one constrained mnec
    ...
    And the value of the objective function initially should be 162.76
    And the remedial action "PST_pst_remedial_action_BBE2AA1  BBE3AA1  1" is used in preventive
    And the tap of PstRangeAction "PST_pst_remedial_action_BBE2AA1  BBE3AA1  1" should be 13 in preventive
    And the margin on cnec "critical_branch - BBE2AA1 ->BBE3AA1  - preventive" after PRA should be 652.70 A
    And the margin on cnec "monitored_element - BBE1AA1 ->BBE3AA1  - preventive" after PRA should be 28.88 A
    And the value of the objective function after PRA should be -652.70