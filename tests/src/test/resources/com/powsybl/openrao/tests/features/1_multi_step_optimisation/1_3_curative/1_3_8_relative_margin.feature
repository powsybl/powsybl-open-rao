...
Feature: 1.3.8: Cross-validation curative and relative margin
  ...
  Scenario: 1.3.8.1: Full optimization in relative margin with negative margin in curative
    ...
    Then the relative margin on cnec "BBE2AA1  FFR3AA1  1 - preventive" after PRA should be 278 A
    ...
    Then the relative margin on cnec "BBE4AA1  FFR5AA1  1 - preventive" after PRA should be 513 A
    Then the relative margin on cnec "FFR2AA1  DDE3AA1  1 - preventive" after PRA should be 543 A
  ...
  @fast @rao @ac @contingency-scenarios @max-min-relative-margin
  Scenario: 1.3.8.3: Full optimization in relative margin with positive margin in curative
    ...
    Then the remedial action "open_fr1_fr3" is used after "co1_fr2_fr3_1" at "curative"
    Then the tap of PstRangeAction "pst_fr" should be 12 after "co1_fr2_fr3_1" at "curative"
    Then the worst relative margin is 278 A on cnec "BBE2AA1  FFR3AA1  1 - preventive"
    Then the relative margin on cnec "BBE2AA1  FFR3AA1  1 - preventive" after PRA should be 278 A
    ...
    Then the relative margin on cnec "BBE4AA1  FFR5AA1  1 - preventive" after PRA should be 514 A
    Then the relative margin on cnec "FFR2AA1  DDE3AA1  1 - preventive" after PRA should be 543 A
    ...
    Then the value of the objective function after CRA should be -278