...
Feature: 3.4.1: Costly network actions optimization
  This feature covers the objective-function type MIN_COST with network actions.

  @fast @preventive-only @costly @rao
  Scenario: 3.4.1.1: Selection of cheapest of 3 equivalent network actions
  ...
  @fast @preventive-only @costly @rao
  Scenario: 3.4.1.2: Selection of cheapest network action even if it does not maximize minimum margin
  ...
  @fast @preventive-only @costly @rao
  Scenario: 3.4.1.3: Selection of the two cheapest network actions
  ...
  @fast @preventive-only @costly @rao
  Scenario: 3.4.1.4: Selection of cheapest of 3 equivalent network actions but overload remains at the end of RAO
  ...
  @fast @preventive-only @costly @rao
  Scenario: 3.4.1.5: Sub-optimal case
  ...
  @fast @costly @rao
  Scenario: 3.4.1.6: Preventive and auto optimization - 1 scenario
  ...
  @fast @costly @rao
  Scenario: 3.4.1.7: Preventive and auto optimization - 2 scenarios
  ...
  @fast @costly @rao
  Scenario: 3.4.1.8: Preventive and auto optimization - 2 scenarios with PRA
  ...
  @fast @costly @rao
  Scenario: 3.4.1.9: Preventive and curative optimization - 1 scenario - no auto instant
  ...
  @fast @costly @rao
  Scenario: 3.4.1.9.bis: Preventive and curative optimization - 1 scenario - with auto instant
  ...
  @fast @costly @rao
  Scenario: 3.4.1.10: Preventive, auto and curative optimization - 1 scenario
  ...
  @fast @costly @rao
  Scenario: 3.4.1.11: Preventive, auto and curative optimization - 4 comprehensive scenarios
  ...
  @fast @costly @rao
  Scenario: 3.4.1.12: Preventive and auto optimization - curative overload
