...
Feature: US 7.14: Use a refProg file to calculate the loop-flows
  ...
  Scenario: 7.14.2 : run a search tree RAO with a refProg file
    ...
    Then the worst margin is -685.0 A
    Then the worst margin is -685.0 A on cnec "FFR2AA1  DDE3AA1  1 - preventive"
  ...
  Scenario: 7.14.3 : run another search tree RAO with a refProg file
    ...
    Then the worst margin is -548.0 A
    Then the worst margin is -548.0 A on cnec "FFR2AA1  DDE3AA1  1 - preventive"
