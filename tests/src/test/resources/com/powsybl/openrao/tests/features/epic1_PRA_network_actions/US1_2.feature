...
Feature: US 1.2: Import of simple network actions as preventive remedial action free to use
  ...
  Scenario: US 1.2.1
    ...
    Then it should have the following flow CNECs:
      ...
      | Tie-line FR BE | BBE2AA1  FFR3AA1  1 | preventive |                     | yes       | no        | 5000.0   | 5000.0    | 380.0              | 380.0               |
      | Tie-line FR BE | BBE2AA1  FFR3AA1  1 | curative   | Contingency FR1 FR3 | yes       | no        | 5000.0   | 5000.0    | 380.0              | 380.0               |
      | Tie-line FR BE | BBE2AA1  FFR3AA1  1 | outage     | Contingency FR1 FR3 | yes       | no        | 5000.0   | 5000.0    | 380.0              | 380.0               |
      | Tie-line FR DE | FFR2AA1  DDE3AA1  1 | preventive |                     | yes       | no        | 5000.0   | 5000.0    | 380.0              | 380.0               |
      | Tie-line FR DE | FFR2AA1  DDE3AA1  1 | curative   | Contingency FR1 FR3 | yes       | no        | 5000.0   | 5000.0    | 380.0              | 380.0               |
      | Tie-line FR DE | FFR2AA1  DDE3AA1  1 | outage     | Contingency FR1 FR3 | yes       | no        | 5000.0   | 5000.0    | 380.0              | 380.0               |
    Then the flow cnecs should have the following thresholds:
      | CnecId                                               | Unit   | Min   | Max  | Side  |
      | BBE2AA1  FFR3AA1  1 - preventive                     | AMPERE | -1500 | 1500 | TWO |
      | BBE2AA1  FFR3AA1  1 - Contingency FR1 FR3 - outage   | AMPERE | -1500 | 1500 | TWO |
      | BBE2AA1  FFR3AA1  1 - Contingency FR1 FR3 - curative | AMPERE | -1500 | 1500 | TWO |
