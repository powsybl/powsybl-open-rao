...
Feature: US 7.12: Compute loop-flows for N-1 Cnecs
  ...
  Scenario: 7.12.1 : loop-flow computation on 12 nodes network on N and N-1 states
    ...
    And the loopflow on cnec "DDE2AA1  NNL3AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be -396.0 MW
    And the loopflow on cnec "NNL1AA1  NNL3AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be 299.0 MW
    And the loopflow on cnec "NNL1AA1  NNL2AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be 201.0 MW
    And the loopflow on cnec "FFR2AA1  FFR3AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be -1104.0 MW
    And the loopflow on cnec "NNL2AA1  BBE3AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be -396.0 MW
    And the loopflow on cnec "BBE1AA1  BBE3AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be -757.0 MW
    And the loopflow on cnec "BBE1AA1  BBE2AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be -910.0 MW
    And the loopflow on cnec "DDE2AA1  DDE3AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be -736.0 MW
    And the loopflow on cnec "FFR1AA1  FFR2AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be 1000.0 MW
    And the loopflow on cnec "FFR2AA1  DDE3AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be -396.0 MW
    And the loopflow on cnec "DDE1AA1  DDE3AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be -868.0 MW
    And the loopflow on cnec "DDE1AA1  DDE2AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be -132.0 MW
    And the loopflow on cnec "NNL2AA1  NNL3AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be 98.0 MW
    And the loopflow on cnec "BBE2AA1  FFR3AA1  1 - Contingency FR1 FR3 - outage" after loopflow computation should be -396.0 MW