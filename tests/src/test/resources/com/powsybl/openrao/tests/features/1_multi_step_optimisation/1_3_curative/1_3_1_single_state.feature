...
Feature: 1.3.1: Solve a RAO for a single preventive or curative state
  ...
  Scenario: 1.3.1.1: Solve preventive perimeter alone
...
#    Then I export rao reports to "reports/reports_1_3_1_1.txt"
  ...
  Scenario: 1.3.1.2: Solve curative perimeter alone at curative instant
    Given network file is "epic13/TestCase12NodesForCurative.uct"
    Given crac file is "epic13/12nodes_pst_topo_frm_cbcora_curative.xml"
    Given configuration file is "common/RaoParameters_maxMargin_ampere_ac.json"
    When I launch rao at "2019-01-08 00:30" after "Contingency" at "curative"
#    Then I export rao reports to "reports/reports_1_3_1_2.txt"
    Then the execution details should be "The RAO only went through first preventive"
