...
Feature: US 93.3: Intertemporal generator constraints
  ...
  Scenario: US 93.3.2.b: Load constrained by its pMax
  Duplicate of US 93.3.2 but with the constrains on a load instead of a generator.
    Given configuration file is "epic93/RaoParameters_minCost_megawatt_dc_0_shift.json"
    Given intertemporal constraints are in file "epic93/intertemporal-constraints-with-load-pmax.json" and rao inputs are:
      | Timestamp        | Network             | CRAC                                 |
      | 2025-11-04 00:30 | epic93/6Nodes.xiidm | epic93/us93_3/crac_202511040030.json |
      | 2025-11-04 01:30 | epic93/6Nodes.xiidm | epic93/us93_3/crac_202511040130.json |
      | 2025-11-04 02:30 | epic93/6Nodes.xiidm | epic93/us93_3/crac_202511040230.json |
  ...
  1000 MW/h so the generator must be switched on at 02:00. Similarly, the downward power gradient us -2000 MW/h so the
  ...
  Scenario: US 93.3.3.b: Upward and downward power gradients
  Duplicate of US 93.3.3 but with the constrains on a load instead of a generator.
    Given configuration file is "epic93/RaoParameters_minCost_megawatt_dc_0_shift.json"
    Given intertemporal constraints are in file "epic93/intertemporal-constraints-with-load-gradients.json" and rao inputs are:
      | Timestamp        | Network             | CRAC                                 |
      | 2025-11-04 00:30 | epic93/6Nodes.xiidm | epic93/us93_3/crac_202511040030.json |
      | 2025-11-04 01:30 | epic93/6Nodes.xiidm | epic93/us93_3/crac_202511040130.json |
      | 2025-11-04 02:30 | epic93/6Nodes.xiidm | epic93/us93_3/crac_202511040230.json |
