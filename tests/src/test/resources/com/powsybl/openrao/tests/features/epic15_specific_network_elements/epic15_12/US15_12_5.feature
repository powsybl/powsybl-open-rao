...
Feature: US 15.12.5: Handle HVDC range actions in RAO
  ...
  Scenario: US 15.12.5.4: HVDC range action with outage CNEC
    ...
    And the worst margin is 176.82 MW
    And the margin on cnec "be1_be2_n - BBE1AA11->BBE2AA11 - preventive" after PRA should be 176.82 MW
  ...
  Scenario: US 15.12.5.6: HVDC range action with two curative perimeters and negative initial flow
    ...
    And the worst margin is 141.29 MW
    And the margin on cnec "be1_be2_n - BBE1AA11->BBE2AA11 - preventive" after PRA should be 143.28 MW
