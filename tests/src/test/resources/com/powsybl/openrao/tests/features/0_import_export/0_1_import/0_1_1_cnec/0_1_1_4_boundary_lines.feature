...
Feature: 0.1.1.4: Boundary lines
  #TODO: This feature covers

  @fast @rao @dc @preventive-only @max-min-margin
  Scenario: 0.1.1.4.1 : Boundary line with no generation, RAO in MW
  ...
  Scenario: 0.1.1.4.2 : Boundary line with no generation, RAO in A (same case as the previous scenario, but in A)
    Given network file is "epic14/TestCase12NodesXnodeNoGen.uct" for CORE CC
    Given crac file is "epic14/cbcora_ep14us6.xml"
  ...
  @fast @rao @dc @preventive-only @max-min-margin
  Scenario: 0.1.1.4.3 : Boundary line with generation, RAO in MW
  ...
  @fast @rao @ac @preventive-only @max-min-margin
  Scenario: 0.1.1.4.4 : Boundary line with generation, RAO in A (same case as the previous scenario, but in A)
    Given network file is "epic14/TestCase12NodesXnodeWithGen.uct" for CORE CC
    Given crac file is "epic14/cbcora_ep14us6.xml"
    Given configuration file is "common/RaoParameters_maxMargin_ampere.json"
    When I launch rao at "2019-01-08 12:00"
