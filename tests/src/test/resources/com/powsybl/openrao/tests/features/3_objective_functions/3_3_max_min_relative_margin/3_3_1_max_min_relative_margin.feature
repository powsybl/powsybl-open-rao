...
Feature: 3.3.1: Linear RAO with relative margin
  ...
  Scenario: 3.3.1.1: Unsecured case
  ...
  @fast @rao @ac @preventive-only @max-min-relative-margin
  Scenario: 3.3.1.3: Secured case with open monitored branch
