...
Feature: 1.5.1: Multi-curative
  ...
  Scenario: 1.5.1.1: All combinations of auto and curative states
    ...
    Then the worst margin is -229.74 A
  ...
  Scenario: 1.5.1.2: Multi-curative with PST range actions and Topological actions
    ...
    Then the worst margin is 10.08 A
    # Basecase / After PRA
  ...
  @fast @rao @ac @multi-curative @secure-flow
  Scenario: 1.5.1.3: Multi-curative with AUTO + curative instant 1 without CRAs
  ...
  Scenario: 1.5.1.4: Same case as previous one with ra limitations : 0 curative1 RAs, 0 curative2 RAs
    ...
    Then the execution details should be "The RAO only went through first preventive"
    Then its security status should be "UNSECURED"
    Then the worst margin is -430.48 A
  ...
  @fast @rao @ac @multi-curative @secure-flow
  Scenario: 1.5.1.6: Multi-curative with AUTO + curative instant 3 without CRAs
    Given network file is "epic91/TestCase16Nodes_multi_curative.uct"
  ...
  @fast @rao @ac @multi-curative @secure-flow
  Scenario: 1.5.1.7: Multi-curative with curative instant 1 without CRAs
    Given network file is "epic91/TestCase16Nodes_multi_curative.uct"
    ...
    Then the execution details should be "The RAO only went through first preventive"
    Then its security status should be "SECURED"
    Then the worst margin is 32.7 A
    # Basecase / After PRA (PATL 500 MW)
  ...
  @fast @rao @ac @multi-curative @max-min-margin
  Scenario: 1.5.1.8: Multi-curative with curative instant 2 without CRAs
    Given network file is "epic91/TestCase16Nodes_multi_curative.uct"
    ...
    Then the execution details should be "The RAO only went through first preventive"
    Then its security status should be "SECURED"
    Then the worst margin is 25.37 A
  ...
  @fast @rao @ac @multi-curative @secure-flow
  Scenario: 1.5.1.9: Multi-curative with curative instant 3 without CRAs
  ...
  @fast @rao @ac @multi-curative @secure-flow
  Scenario: 1.5.1.10: Multi-curative with ARA and no CRAs
    Given network file is "epic91/TestCase16Nodes_multi_curative.uct"
  ...
  @fast @rao @ac @multi-curative @secure-flow
  Scenario: 1.5.1.11: Multi-curative without CRAs
    Given network file is "epic91/TestCase16Nodes_multi_curative.uct"
  ...
  @fast @rao @ac @multi-curative @max-min-margin
  Scenario: 1.5.1.12: Multi-curative with ARA and only C1RA
    Given network file is "epic91/TestCase16Nodes_multi_curative.uct"
  ...
  @fast @rao @ac @multi-curative @max-min-margin
  Scenario: 1.5.1.13: Multi-curative with ARA and only C2RA
    Given network file is "epic91/TestCase16Nodes_multi_curative.uct"
  ...
  @fast @rao @ac @multi-curative @max-min-margin
  Scenario: 1.5.1.14: Multi-curative with ARA and only C3RA
    Given network file is "epic91/TestCase16Nodes_multi_curative.uct"
  ...
  @fast @rao @ac @multi-curative @max-min-margin
  Scenario: 1.5.1.15: Multi-curative with only C1RA
    Given network file is "epic91/TestCase16Nodes_multi_curative.uct"
    ...
    Then the execution details should be "The RAO only went through first preventive"
    Then its security status should be "SECURED"
    Then the worst margin is 329.24 A
    # Basecase / After PRA (PATL 500 MW)
    Then the initial flow on cnec "BBE1AA1  BBE3AA1  1 - preventive" should be -326.0 MW on side 1
    Then 1 remedial actions are used in preventive
    Then the remedial action "PRA_CLOSE_BE1_BE2_1" is used after "Contingency DE2 NL3 1" at "preventive"
  ...
  @fast @rao @ac @multi-curative @max-min-margin
  Scenario: 1.5.1.16: Multi-curative with only C2RA
    Given network file is "epic91/TestCase16Nodes_multi_curative.uct"
  ...
  @fast @rao @ac @multi-curative @max-min-margin
  Scenario: 1.5.1.17: Multi-curative with only C3RA
    Given network file is "epic91/TestCase16Nodes_multi_curative.uct"
    ...
    Then the execution details should be "The RAO only went through first preventive"
    Then its security status should be "SECURED"
    Then the worst margin is 35.45 A
    # Basecase / After PRA (PATL 500 MW)
    Then the initial flow on cnec "BBE1AA1  BBE3AA1  1 - preventive" should be -326.0 MW on side 1
    Then 1 remedial actions are used in preventive
    Then the remedial action "PRA_CLOSE_BE1_BE2_1" is used after "Contingency DE2 NL3 1" at "preventive"
  ...
  @fast @rao @ac @multi-curative @secure-flow
  Scenario: 1.5.1.18: Multi-curative CNECs with PRAs only
  ...
  Scenario: 1.5.1.20: Multi-curative CNECs with no CRA for curative1 and 2nd PRAO
    ...
    Then its security status should be "SECURED"
    # Initial
    Then the initial flow on cnec "NNL2AA1  BBE3AA1  1 - preventive" should be 500.0 MW on side 1
    Then the initial flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - outage" should be 583.33 MW on side 1
    Then the initial flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative1" should be 583.33 MW on side 1
    Then the initial flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative2" should be 583.33 MW on side 1
    Then the initial flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative3" should be 583.33 MW on side 1
    # Preventive
    Then 1 remedial actions are used in preventive
    Then the remedial action "PRA_PST_BE" is used in preventive
    Then the tap of PstRangeAction "PRA_PST_BE" should be -11 in preventive
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - preventive" after PRA should be 392.0 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - outage" after PRA should be 493.4 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative1" after PRA should be 493.4 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative2" after PRA should be 493.4 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative3" after PRA should be 493.4 MW on side 1
    # Curative1
    Then 0 remedial actions are used after "Contingency DE2 DE3 1" at "curative1"
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative1" after "curative1" instant remedial actions should be 493.4 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative2" after "curative1" instant remedial actions should be 493.4 MW on side 1
    ...
    Then 1 remedial actions are used after "Contingency DE2 DE3 1" at "curative2"
    Then the remedial action "CRA_CLOSE_NL2_BE3_2" is used after "Contingency DE2 DE3 1" at "curative2"
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative2" after "curative2" instant remedial actions should be 263.1 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative3" after "curative2" instant remedial actions should be 263.1 MW on side 1
     # Curative3
    Then 1 remedial actions are used after "Contingency DE2 DE3 1" at "curative3"
    Then the remedial action "CRA_CLOSE_NL2_BE3_3" is used after "Contingency DE2 DE3 1" at "curative3"
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative3" after "curative3" instant remedial actions should be 179.4 MW on side 1

  @fast @rao @ac @multi-curative @secure-flow
  Scenario: 1.5.1.21: Multi-curative CNECs with no CRA for curative2 and 2nd PRAO
    ...
    Then the execution details should be "Second preventive improved first preventive results"
    Then its security status should be "SECURED"
    Then the worst margin is 56.02 A
    # Preventive
    Then 1 remedial actions are used in preventive
    Then the remedial action "PRA_CLOSE_NL2_BE3_2" is used in preventive
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - preventive" after PRA should be 270.3 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - outage" after PRA should be 311.1 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative1" after PRA should be 311.1 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative2" after PRA should be 311.1 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative3" after PRA should be 311.1 MW on side 1
    # Curative1
    Then 1 remedial actions are used after "Contingency DE2 DE3 1" at "curative1"
    Then the remedial action "CRA_PST_BE" is used after "Contingency DE2 DE3 1" at "curative1"
    Then the tap of PstRangeAction "CRA_PST_BE" should be -11 after "Contingency DE2 DE3 1" at "curative1"
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative1" after "curative1" instant remedial actions should be 263.1 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative2" after "curative1" instant remedial actions should be 263.1 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative3" after "curative1" instant remedial actions should be 263.1 MW on side 1
    # Curative2
    Then 0 remedial actions are used after "Contingency DE2 DE3 1" at "curative2"
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative2" after "curative2" instant remedial actions should be 263.1 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative3" after "curative2" instant remedial actions should be 263.1 MW on side 1
  ...
  @fast @rao @ac @multi-curative @secure-flow
  Scenario: 1.5.1.22: Multi-curative CNECs with no CRA for curative3 and 2nd PRAO
    ...
    Then 1 remedial actions are used after "Contingency DE2 DE3 1" at "curative2"
    Then the remedial action "CRA_CLOSE_NL2_BE3_2" is used after "Contingency DE2 DE3 1" at "curative2"
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative2" after "curative2" instant remedial actions should be 179.4 MW on side 1
    Then the flow on cnec "NNL2AA1  BBE3AA1  1 - Contingency DE2 DE3 1 - curative3" after "curative2" instant remedial actions should be 179.4 MW on side 1
     # Curative3
