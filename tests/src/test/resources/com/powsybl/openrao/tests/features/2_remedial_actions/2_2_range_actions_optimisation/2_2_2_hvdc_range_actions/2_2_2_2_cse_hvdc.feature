...
Feature: 2.2.2.2: Handle CSE's HVDCs with range actions on injections
  # TODO: This feature covers

  @fast @rao @dc @preventive-only @hvdc @max-min-margin
  Scenario: 2.2.2.2.1: UCTE HVDC as InjectionRangeAction with one preventive CNEC
  ...
  @fast @rao @dc @preventive-only @hvdc @max-min-margin
  Scenario: 2.2.2.2.2: UCTE HVDC as InjectionRangeAction with two preventive CNECs
    Given network file is "epic15/TestCase16NodesWithUcteHvdc.uct"
  ...
  @fast @rao @dc @preventive-only @hvdc @max-min-margin
  Scenario: 2.2.2.2.3: UCTE HVDC as InjectionRangeAction with PST range action and two preventive CNECs
    Given network file is "epic15/TestCase16NodesWithUcteHvdc.uct"
  ...
  @fast @rao @dc @preventive-only @hvdc @max-min-margin
  Scenario: 2.2.2.2.4: UCTE HVDC as InjectionRangeAction with outage CNEC
    Given network file is "epic15/TestCase16NodesWithUcteHvdc.uct"
    ...
    Then the margin on cnec "be1_be2_n - BBE1AA11->BBE2AA11 - preventive" after PRA should be 176 MW
    Then the margin on cnec "be4_fr5_co1 - BBE4AA11->FFR5AA11  - co1_be1_fr5 - outage" after PRA should be 191 MW
  ...
  Scenario: 2.2.2.2.5: UCTE HVDC as InjectionRangeAction with one curative perimeter
    Given network file is "epic15/TestCase16NodesWithUcteHvdc.uct"
  ...
  @fast @rao @dc @contingency-scenarios @hvdc @max-min-margin
  Scenario: 2.2.2.2.6: UCTE HVDC as InjectionRangeAction with two curative perimeters and negative initial flow
    Given network file is "epic15/TestCase16NodesWithUcteHvdc.uct"
    ...
    Then the worst margin is 110 MW
    Then the margin on cnec "be1_be2_n - BBE1AA11->BBE2AA11 - preventive" after PRA should be 127 MW
    Then the margin on cnec "nl2_be3_co2 - NNL2AA11->BBE3AA11  - co2_be1fr5_be4fr5 - outage" after PRA should be 111 MW
    Then the margin on cnec "be4_fr5_co1 - BBE4AA11->FFR5AA11  - co1_be1_fr5 - outage" after PRA should be 110 MW
    Then the margin on cnec "nl2_be3_co2 - NNL2AA11->BBE3AA11  - co2_be1fr5_be4fr5 - curative" after CRA should be 165 MW
    Then the margin on cnec "be4_fr5_co1 - BBE4AA11->FFR5AA11  - co1_be1_fr5 - curative" after CRA should be 285 MW
    Then the margin on cnec "be1_fr5_n - BBE1AA11->FFR5AA11 - preventive" after PRA should be 285 MW

  @fast @rao @dc @preventive-only @hvdc @max-min-margin
  Scenario: 2.2.2.2.7: UCTE HVDC as InjectionRangeAction with a negative optimal setpoint
    Given network file is "epic15/TestCase16NodesWithUcteHvdc.uct"
  ...
  @fast @rao @dc @contingency-scenarios @hvdc @max-min-margin
  Scenario: 2.2.2.2.8: UCTE HVDC as InjectionRangeAction and PST filtering
    Given network file is "epic15/TestCase16NodesWithUcteHvdc.uct"
