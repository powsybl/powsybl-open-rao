...
Feature: 1.2.1: Simulate topological automatons right after preventive optimization
  This feature covers the topological automatons after preventive, depending on the usage rules.
