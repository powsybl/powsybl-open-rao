...
Feature: IDCC POC v1
  ...
  @slow @rao @idcc-v1
  Scenario: 20240711
    Given network files are in folder "idcc/20240711-FID2-734-v1-10V1001C--00264T-to-10V1001C--00085T"
  ...
  @slow @rao @idcc-v1
  Scenario: 20240712
    Given network files are in folder "idcc/20240712-FID2-734-v1-10V1001C--00264T-to-10V1001C--00085T"
  ...
  @slow @rao @idcc-v1
  Scenario: 20240716
    Given network files are in folder "idcc/20240716-FID2-734-v1-10V1001C--00264T-to-10V1001C--00085T"
  ...
  @slow @rao @idcc-v1
  Scenario: 20240730
    Given network files are in folder "idcc/20240730-FID2-734-v1-10V1001C--00264T-to-10V1001C--00085T"
  ...
  @slow @rao @idcc-v1
  Scenario: 20240826
    Given network files are in folder "idcc/20240826-FID2-734-v1-10V1001C--00264T-to-10V1001C--00085T"
  ...
  @slow @rao @idcc-v1
  Scenario: 20240906
    Given network files are in folder "idcc/20240906-FID2-734-v1-10V1001C--00264T-to-10V1001C--00085T"
  ...
  @slow @rao @idcc-v1
  Scenario: 20240910
    Given network files are in folder "idcc/20240910-FID2-734-v1-10V1001C--00264T-to-10V1001C--00085T"
  ...
  @slow @rao @idcc-v1
  Scenario: 20240926
    Given network files are in folder "idcc/20240926-FID2-734-v1-10V1001C--00264T-to-10V1001C--00085T"
  ...
  @slow @rao @idcc-v1
  Scenario: 20241013
    Given network files are in folder "idcc/20241013-FID2-734-v1-10V1001C--00264T-to-10V1001C--00085T"
  ...
  @slow @rao @idcc-v1
  Scenario: 20241028
    Given network files are in folder "idcc/20241028-FID2-734-v1-10V1001C--00264T-to-10V1001C--00085T"
