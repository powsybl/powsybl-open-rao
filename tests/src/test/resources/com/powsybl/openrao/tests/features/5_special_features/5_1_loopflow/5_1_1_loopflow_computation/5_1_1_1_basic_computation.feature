...
Feature: 5.1.1.1: Loopflow computation (not within the RAO)
  This feature covers loopflow_computation with OpenLoadFlow.

  @fast @rao @dc @preventive-only @secure-flow
  Scenario: 5.1.1.1.1: optimise network action without loop flow limitation
  ...
  Scenario: 5.1.1.1.2: loopflow computation on 12 nodes network with proportional GLSKs
    Given network file is "common/TestCase12Nodes.uct"
    ...
    Then the loopflow on cnec "NNL1AA1  NNL3AA1  1 - preventive" after loopflow computation should be 354.0 MW
    Then the loopflow on cnec "NNL1AA1  NNL2AA1  1 - preventive" after loopflow computation should be 334.0 MW
    Then the loopflow on cnec "FFR2AA1  FFR3AA1  1 - preventive" after loopflow computation should be -870.0 MW
    Then the loopflow on cnec "NNL2AA1  BBE3AA1  1 - preventive" after loopflow computation should be -124.0 MW
    Then the loopflow on cnec "BBE1AA1  BBE3AA1  1 - preventive" after loopflow computation should be -530.0 MW
    Then the loopflow on cnec "BBE1AA1  BBE2AA1  1 - preventive" after loopflow computation should be -898.0 MW
    Then the loopflow on cnec "FFR1AA1  FFR3AA1  1 - preventive" after loopflow computation should be -77.0 MW
    Then the loopflow on cnec "DDE2AA1  DDE3AA1  1 - preventive" after loopflow computation should be -15.0 MW
    Then the loopflow on cnec "FFR1AA1  FFR2AA1  1 - preventive" after loopflow computation should be 792.0 MW
    Then the loopflow on cnec "FFR2AA1  DDE3AA1  1 - preventive" after loopflow computation should be -124.0 MW
    Then the loopflow on cnec "DDE1AA1  DDE3AA1  1 - preventive" after loopflow computation should be 13.0 MW
    Then the loopflow on cnec "DDE1AA1  DDE2AA1  1 - preventive" after loopflow computation should be 28.0 MW
  ...
  @fast @loopflow-computation @dc @loopflow
  Scenario: 5.1.1.1.3: loopflow computation on 12 nodes network with proportional GLSKs
    Given network file is "common/TestCase12Nodes.uct"
    Given crac file is "epic7/crac_lf.json"
