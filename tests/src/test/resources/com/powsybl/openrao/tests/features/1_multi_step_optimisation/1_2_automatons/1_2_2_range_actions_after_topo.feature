...
Feature: 1.2.2: Simulate range action automatons right after topological automatons
  This feature covers the diferent types of range action automatons.

  @fast @rao @ac @contingency-scenarios @hvdc @max-min-margin
  Scenario: 1.2.2.1: 1 auto HVDC
    ...
    Then 2 remedial actions are used after "co1_be1_fr5" at "auto"
    Then the remedial action "acEmulationDeactivation_BBE2AA11 FFR3AA11 1" is used after "co1_be1_fr5" at "auto"
    Then the remedial action "ARA_HVDC" is used after "co1_be1_fr5" at "auto"
    Then the setpoint of RangeAction "ARA_HVDC" should be 964 MW after "co1_be1_fr5" at "auto"
    Then the margin on cnec "be3_be4_co1 - BBE3AA11->BBE4AA11  - co1_be1_fr5 - auto" after ARA should be -42.73 A
