...
Feature: US 92.3: Exhaustive costly optimization - APPROXIMATED_INTEGERS PSTs
  ...
  The PST is moved to tap -6 to secure the preventive perimeter for a total cost of 110
  (20 for activation + 6 * 15 for variation). Then, there are two ways to secure the curative perimeter:
  1. move PST to tap -8 => cost of 20 + 2 * 15 = 50
  2. (optimal) close line BE-FR 3 => cost of 10 = 10
    ...
    And the value of the objective function after CRA should be 120
  ...
  Scenario: US 92.3.4: Preventive and curative PST + curative topological action - 2 scenarios
    ...
    And the tap of PstRangeAction "pstBeFr5" should be -6 in preventive
    # Activation of pstBeFr4 (20) + 6 taps moved (6 * 15) + overload penalty (36.98 * 10000)
    And the value of the objective function after PRA should be 37086.57
    ...
    And the tap of PstRangeAction "pstBeFr5" should be -7 after "coBeFr2" at "curative"
