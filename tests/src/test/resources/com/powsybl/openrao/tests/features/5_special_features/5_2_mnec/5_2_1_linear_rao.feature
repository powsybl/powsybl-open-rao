...
Feature: 5.2.1: Handle MNECs in linear RAO
  # TODO: This feature covers

  @fast @rao @dc @preventive-only @max-min-margin
  Scenario: 5.2.1.1: reference run, no MNEC
  ...
  Scenario: 5.2.1.2: margin on MNEC should stay positive (initial margin > 50MW)
  ...
  @fast @rao @dc @preventive-only @mnec @max-min-margin
  Scenario: 5.2.1.3: margin on MNEC should stay above initial value -50 MW [1] (initial margin < 0MW)
  ...
  @fast @rao @dc @preventive-only @mnec @max-min-margin
  Scenario: 5.2.1.4: margin on MNEC should stay above initial value -50 MW [2] (50MW > initial margin > 0MW)
