...
Feature: 5.1.2.2: Handle optimisation unfeasibility with loopflow constraints
  ...
  Scenario: 5.1.2.2.1: Simple search tree RAO with LF limitation and infeasible linear problem
