...
Feature: 2.3.1: Basic redispatching actions (free and costly)
  # TODO: This feature covers

  @fast @rao @dc @redispatching @preventive-only @max-min-margin
  Scenario: 2.3.1.1.a: Extremely basic redispatching on 2 nodes network - maxMargin
  ...
  @fast @rao @dc @redispatching @preventive-only @max-min-margin
  Scenario: 2.3.1.1.bis: Extremely basic redispatching on 2 nodes network - maxMargin - load
  ...
  Scenario: 2.3.1.2: Extremely basic redispatching on 2 nodes network - minCost
  ...
  @fast @rao @dc @redispatching @preventive-only @max-min-margin
  Scenario: 2.3.1.4: Multiple redispatching actions keep network balanced - max min margin
  ...
  @fast @rao @dc @redispatching @preventive-only @costly
  Scenario: 2.3.1.5: Multiple redispatching actions keep network balanced with more "complex" keys - min cost
  ...
  @fast @rao @dc @redispatching @preventive-only @costly
  Scenario: 2.3.1.6: Redispatching with disconnected generator
