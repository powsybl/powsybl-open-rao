...
Feature: US 7.9: Linear RAO with loopflow limitation
  ...
  Scenario: US 7.9.1: linear RAO without LF limitation
    ...
    And the worst margin is 218.98 MW
    And the margin on cnec "FFR1AA1  FFR2AA1  1 - preventive" after PRA should be 218.98 MW
  ...
  Scenario: US 7.9.2: linear RAO with LF limited by predefined threshold (10% of Fmax)
    ...
    Then the worst margin is 199.38 MW
    And the margin on cnec "FFR1AA1  FFR2AA1  1 - preventive" after PRA should be 199.38 MW
  ...
  Scenario: US 7.9.3: linear RAO with LF limited by initial value
    ...
    Then the worst margin is 166.67 MW
    And the margin on cnec "FFR1AA1  FFR2AA1  1 - preventive" after PRA should be 166.67 MW
