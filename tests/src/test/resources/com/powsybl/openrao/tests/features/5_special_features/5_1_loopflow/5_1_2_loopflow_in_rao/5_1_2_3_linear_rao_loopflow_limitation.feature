...
Feature: 5.1.2.3: Linear RAO with loopflow limitation
  ...
  Scenario: 5.1.2.3.2: linear RAO with LF limited by predefined threshold (10% of Fmax)
    Given network file is "common/TestCase12Nodes.uct"
    Given crac file is "epic7/crac_lf_rao_1.json"
    ...
    Then the loopflow threshold on cnec "DDE2AA1  NNL3AA1  1 - preventive" should be 500.0 MW
    Then the loopflow threshold on cnec "NNL2AA1  BBE3AA1  1 - preventive" should be 500.0 MW
    Then the loopflow threshold on cnec "FFR2AA1  DDE3AA1  1 - preventive" should be 500.0 MW
    Then the loopflow threshold on cnec "BBE2AA1  FFR3AA1  1 - preventive" should be 500.0 MW
    ...
    Then the loopflow on cnec "DDE2AA1  NNL3AA1  1 - preventive" after PRA should be -489.0 MW
    Then the loopflow on cnec "NNL2AA1  BBE3AA1  1 - preventive" after PRA should be -489.0 MW
  ...
  @fast @rao @dc @preventive-only @loopflow @max-min-margin
  Scenario: 5.1.2.3.3: linear RAO with LF limited by initial value
    Given network file is "common/TestCase12Nodes.uct"
    Given crac file is "epic7/crac_lf_rao_1.json"
    Given loopflow glsk file is "common/glsk_lots_of_lf_12nodes.xml"
    Given configuration file is "epic7/RaoParameters_maxMargin_mw_dc_lf_false_10_100.json"
    ...
    Then the loopflow threshold on cnec "DDE2AA1  NNL3AA1  1 - preventive" should be 250.0 MW
    Then the loopflow threshold on cnec "NNL2AA1  BBE3AA1  1 - preventive" should be 250.0 MW
    Then the loopflow threshold on cnec "FFR2AA1  DDE3AA1  1 - preventive" should be 250.0 MW
    Then the loopflow threshold on cnec "BBE2AA1  FFR3AA1  1 - preventive" should be 250.0 MW
    Then the initial loopflow on cnec "DDE2AA1  NNL3AA1  1 - preventive" should be -391.0 MW
    Then the initial loopflow on cnec "NNL2AA1  BBE3AA1  1 - preventive" should be -391.0 MW
    Then the initial loopflow on cnec "FFR2AA1  DDE3AA1  1 - preventive" should be -391.0 MW
    Then the initial loopflow on cnec "BBE2AA1  FFR3AA1  1 - preventive" should be -391.0 MW
    Then the loopflow on cnec "DDE2AA1  NNL3AA1  1 - preventive" after PRA should be -391.0 MW
    Then the loopflow on cnec "NNL2AA1  BBE3AA1  1 - preventive" after PRA should be -391.0 MW
    Then the loopflow on cnec "FFR2AA1  DDE3AA1  1 - preventive" after PRA should be -391.0 MW
    Then the loopflow on cnec "BBE2AA1  FFR3AA1  1 - preventive" after PRA should be -391.0 MW