...
Feature: 6.1.1: PST Regulation
  ...
  @ac @fast @rao @max-min-margin
  Scenario: 6.1.1.1.a: Unsecure case with a globally optimized tap position - PST is the limiting element
  ...
  with the lowest global overload reachable. The PST is the most limiting element at the end of curative.
    ...
    Then the worst margin is -690.23 A
    Then the tap of PstRangeAction "pstBeFr2" should be -16 in preventive
    Then the margin on cnec "cnecBeFr1Preventive" after PRA should be 579.65 A
    Then the tap of PstRangeAction "pstBeFr2" should be -2 after "Contingency BE1 FR1 3" at "curative"
    Then the value of the objective function after CRA should be 690.23
    Then the worst margin is -690.23 A
    Then the value of the objective function after CRA should be 690.23
    Then the margin on cnec "cnecBeFr2Curative" after CRA should be -690.23 A
    Then the margin on cnec "cnecBeFr1Curative" after CRA should be -676.38 A

  @ac @fast @rao @pst-regulation @max-min-margin
  Scenario: 6.1.1.1.b: Duplicate of 6.1.1.1.a with PST regulation
  ...
  limiting element.
    ...
    Then the tap of PstRangeAction "pstBeFr2" should be -16 in preventive
    Then the margin on cnec "cnecBeFr1Preventive" after PRA should be 579.65 A
    Then the tap of PstRangeAction "pstBeFr2" should be 7 after "Contingency BE1 FR1 3" at "curative"
    Then the value of the objective function after CRA should be 1382.77
    Then the worst margin is -1382.77 A
    Then the value of the objective function after CRA should be 1382.77
    Then the margin on cnec "cnecBeFr1Curative" after CRA should be -1382.77 A
    Then the margin on cnec "cnecBeFr2Curative" after CRA should be 15.49 A

  @ac @fast @rao @max-min-margin
  Scenario: 6.1.1.2.a: Unsecure case with a globally optimized tap position - PST not is the limiting element
  The curative scenario cannot be secured, the curative tap is chosen such that both curative CNECs are overloaded but
  with the lowest global overload reachable. The PST is not the most limiting element at the end of curative.
    ...
    Then the tap of PstRangeAction "pstBeFr2" should be -16 in preventive
    Then the margin on cnec "cnecBeFr1Preventive" after PRA should be 1479.65 A
    Then the tap of PstRangeAction "pstBeFr2" should be 4 after "Contingency BE1 FR1 3" at "curative"
    Then the value of the objective function after CRA should be 247.23
    Then the worst margin is -247.23 A
    Then the value of the objective function after CRA should be 247.23
    Then the margin on cnec "cnecBeFr1Curative" after CRA should be -247.23 A
    Then the margin on cnec "cnecBeFr2Curative" after CRA should be -219.56 A

  @ac @fast @rao @pst-regulation @max-min-margin
  Scenario: 6.1.1.2.b: Duplicate of 6.1.1.2.a with PST regulation
  At the end of curative optimization, the PST is still unsecure but can be secured by moving the tap to position 7
  ...
  @ac @fast @rao @max-min-margin
  Scenario: 6.1.1.3.a: 3 contingency scenarios and 3 PSTs with different use cases
  ...
  Each curative scenario is unsecure with some PSTs overloaded.
    ...
    Then the tap of PstRangeAction "pstFr34" should be 0 in preventive
    # Auto taps
    Then the tap of PstRangeAction "pstFr34" should be -15 after "Contingency FR 34" at "auto"
    # Curative taps
    Then the tap of PstRangeAction "pstFr12" should be -10 after "Contingency FR 12" at "curative"
    Then the tap of PstRangeAction "pstFr12" should be 0 after "Contingency FR 23" at "curative"
    Then the tap of PstRangeAction "pstFr12" should be 0 after "Contingency FR 34" at "curative"
    Then the tap of PstRangeAction "pstFr23" should be -6 after "Contingency FR 12" at "curative"
    Then the tap of PstRangeAction "pstFr23" should be -6 after "Contingency FR 23" at "curative"
    Then the tap of PstRangeAction "pstFr23" should be -6 after "Contingency FR 34" at "curative"
    Then the tap of PstRangeAction "pstFr34" should be 0 after "Contingency FR 12" at "curative"
    Then the tap of PstRangeAction "pstFr34" should be 0 after "Contingency FR 23" at "curative"
    Then the tap of PstRangeAction "pstFr34" should be -15 after "Contingency FR 34" at "curative"
    # Curative margins
    Then the margin on cnec "cnecFr12PstCurative - Co12" after CRA should be -384.40 A
    Then the margin on cnec "cnecFr12PstCurative - Co23" after CRA should be -444.08 A
    Then the margin on cnec "cnecFr12PstCurative - Co34" after CRA should be -444.08 A
    Then the margin on cnec "cnecFr23PstCurative - Co12" after CRA should be 184.55 A
    Then the margin on cnec "cnecFr23PstCurative - Co23" after CRA should be -697.26 A
    Then the margin on cnec "cnecFr23PstCurative - Co34" after CRA should be 184.55 A
    Then the margin on cnec "cnecFr34PstCurative - Co12" after CRA should be -444.08 A
    Then the margin on cnec "cnecFr34PstCurative - Co23" after CRA should be -444.08 A
    Then the margin on cnec "cnecFr34PstCurative - Co34" after CRA should be 5.78 A
    # Overall
  ...
  @ac @fast @rao @pst-regulation @max-min-margin
  Scenario: 6.1.1.3.b: Duplicate of 6.1.1.3.a with PST regulation
  ...
  The regulation tap is either -15 if the contingency was parallel to the PST or -5 otherwise.
    ...
    Then the tap of PstRangeAction "pstFr34" should be -15 after "Contingency FR 34" at "auto"
    # Curative taps
    Then the tap of PstRangeAction "pstFr12" should be -15 after "Contingency FR 12" at "curative"
    Then the tap of PstRangeAction "pstFr12" should be -5 after "Contingency FR 23" at "curative"
    Then the tap of PstRangeAction "pstFr12" should be -5 after "Contingency FR 34" at "curative"
    Then the tap of PstRangeAction "pstFr23" should be -6 after "Contingency FR 12" at "curative"
    Then the tap of PstRangeAction "pstFr23" should be -6 after "Contingency FR 23" at "curative"
    Then the tap of PstRangeAction "pstFr23" should be -6 after "Contingency FR 34" at "curative"
    Then the tap of PstRangeAction "pstFr34" should be -5 after "Contingency FR 12" at "curative"
    Then the tap of PstRangeAction "pstFr34" should be -5 after "Contingency FR 23" at "curative"
    Then the tap of PstRangeAction "pstFr34" should be -15 after "Contingency FR 34" at "curative"
    # Curative margins
    Then the margin on cnec "cnecFr12PstCurative - Co12" after CRA should be 5.78 A
    Then the margin on cnec "cnecFr12PstCurative - Co23" after CRA should be 78.98 A
    Then the margin on cnec "cnecFr12PstCurative - Co34" after CRA should be 78.98 A
    Then the margin on cnec "cnecFr23PstCurative - Co12" after CRA should be 184.55 A
    Then the margin on cnec "cnecFr23PstCurative - Co23" after CRA should be -697.26 A
    Then the margin on cnec "cnecFr23PstCurative - Co34" after CRA should be 184.55 A
    Then the margin on cnec "cnecFr34PstCurative - Co12" after CRA should be 78.98 A
    Then the margin on cnec "cnecFr34PstCurative - Co23" after CRA should be 78.98 A
    Then the margin on cnec "cnecFr34PstCurative - Co34" after CRA should be 5.78 A
    # Overall
    Then the value of the objective function after CRA should be 758.18
    Then the worst margin is -758.18 A
  ...
  @ac @fast @rao @max-min-margin
  Scenario: 6.1.1.5.a: Unsecure case with a globally optimized tap position - Monitored line in series with PST
  ...
  @ac @fast @rao @pst-regulation @max-min-margin
  Scenario: 6.1.1.5.b: Duplicate of 6.1.1.5.a with PST regulation
