...
Feature: US 93.3: CORE IDCC data
  ...
  Scenario: US 93.3.1: 20240122
    ...
    Given time-coupled RefProg file is "idcc/20240122-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
  ...
  Scenario: US 93.3.2: 20240131
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240131-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
  ...
  Scenario: US 93.3.3: 20240222
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240222-FID2-632-v3-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                         |
  ...
  Scenario: US 93.3.5: 20240502
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240502-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
  ...
  Scenario: US 93.3.6: 20240526
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240526-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
  ...
  Scenario: US 93.3.7: 20240602
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240602-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                         |
  ...
  Scenario: US 93.3.8: 20240606
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240606-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
  ...
  Scenario: US 93.3.9: 20240628
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240628-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
  ...
  Scenario: US 93.3.10: 20240704
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240704-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                         |
  ...
  Scenario: US 93.3.11: 20240711
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240711-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                   |
  ...
  Scenario: US 93.3.12: 20240712
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240712-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                   |
  ...
  Scenario: US 93.3.13: 20240716
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240716-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
  ...
  Scenario: US 93.3.14: 20240718
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240718-FSC-ID2-REFPROG-v1-10V1001C--00264T-to-10XFR-RTE------Q.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
  ...
  Scenario: US 93.3.16: 20240730
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240730-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
  ...
  Scenario: US 93.3.17: 20240826
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240826-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
  ...
  Scenario: US 93.3.18: 20240906
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240906-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
  ...
  Scenario: US 93.3.19: 20240910
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240910-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
  ...
  Scenario: US 93.3.20: 20240926
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20240926-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
  ...
  Scenario: US 93.3.21: 20241013
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20241013-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
  ...
  Scenario: US 93.3.22: 20241028
    ...
    Given configuration file is "idcc/RAOParameters_minCost_megawatt_dc.json"
    Given time-coupled RefProg file is "idcc/20241028-FID2-632-v2-10V1001C--00264T-to-10V1001C--00085T.xml"
    Given time-coupled rao inputs for CORE are:
      | Timestamp        | Network                                                                 |
