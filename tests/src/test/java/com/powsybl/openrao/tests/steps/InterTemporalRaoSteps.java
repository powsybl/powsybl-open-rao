...
public final class InterTemporalRaoSteps {
    ...
    @When("I export RefProg after redispatching to {string} based on networkWithPras folder {string} and based on raoResults folder {string}")
    public static void generateRefProg(String outputPath, String networkWithPrasPath, String raoResultsPath) throws IOException {
...
//            ReferenceProgram builtRefProg = ReferenceProgramBuilder.buildReferenceProgram(networkTemporalData.getData(firstTimestamp).get(),
//                LoadFlowAndSensitivityParameters.getSensitivityProvider(raoParameters),
...
//            ReferenceProgram generatedRefProg = RefProgImporter.importRefProg(refProgInputStream, firstTimestamp);
        ...
        private static void applyRedispatchingAction (InjectionRangeAction injectionRangeAction,
        double optimizedSetpoint, Network modifiedNetwork, Network initialNetwork){
