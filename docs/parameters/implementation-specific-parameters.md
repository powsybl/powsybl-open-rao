...
- **Expected value**: numeric value, unit: [flow's unit](business-parameters.md#objective-function-parameters) / ° (per degree)
- **Default value**: 0.0
...
- **Expected value**: numeric value, unit: [flow's unit](business-parameters.md#objective-function-parameters) / MW
- **Default value**: 0.0
...
- **Expected value**: numeric values, in [flow's unit](business-parameters.md#objective-function-parameters)
...
#### margin-limit
- **Expected value**: numeric value, in MW or A unit (depending on [flow's unit](business-parameters.md#objective-function-parameters))
- **Default value**: 5
