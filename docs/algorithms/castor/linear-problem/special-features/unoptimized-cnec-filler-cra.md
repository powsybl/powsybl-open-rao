...
> 💡 Unoptimized CNEC constraints are considered in the same unit as the [flow unit](../../../../parameters/business-parameters.md#objective-function-parameters) in the MIP
