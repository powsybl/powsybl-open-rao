...
- the [**lead time**](../../../../input-data/specific-input-data/time-coupled-constraints.md#lead-time), which is the 
  time required by the generator to reach its $P_{\min}$ after it was ordered to start up;
- the [**lag time**](../../../../input-data/specific-input-data/time-coupled-constraints.md#lag-time), which is the
