...
- <span style='color: forestgreen;'>**A**utomatic</span> **R**emedial **A**ctions (shared after a critical outage) hereafter **ARA**. Note that these remedial actions are simulated rather than optimised.
