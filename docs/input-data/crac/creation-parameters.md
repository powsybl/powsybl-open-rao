...
OpenRAO's [CracCreationParameters](https://github.com/powsybl/powsybl-open-rao/blob/|version|t co/data/crac/crac-api/src/main/java/com/powsybl/openrao/data/crac/api/parameters/CracCreationParameters.java) 
