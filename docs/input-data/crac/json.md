...
> [Monitoring](/castor/monitoring/monitoring.md) module with **ANGLE** as physical parameter.
...
> [VoltageMonitoring](/castor/monitoring/monitoring.md) module with **VOLTAGE** as physical parameter.
