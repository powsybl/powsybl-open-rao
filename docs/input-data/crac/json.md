...
| Version | Additions                                                                                                    | Deletions                                                            | Other modifications                                                                                                                                                                                             |
|---------|--------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| v1.1    | Switch Pairs                                                                                                 |                                                                      |                                                                                                                                                                                                                 |
| v1.2    | Injection Range Actions                                                                                      |                                                                      |                                                                                                                                                                                                                 |
| v1.3    | HVDC Range Actions' and Injection Range Actions' initial set-point, OnFlowConstraintInCountry usage rules    |                                                                      |                                                                                                                                                                                                                 |
| v1.4    | AngleCNECs, OnAngleConstraint usage rules                                                                    |                                                                      | FlowCNECs' _frm_ renamed to _reliabilityMargin_                                                                                                                                                                 |
| v1.5    | VoltageCNECs                                                                                                 |                                                                      |                                                                                                                                                                                                                 |
| v1.6    |                                                                                                              |                                                                      | FlowCNEC thresholds' _rule_ (onLeftSide / onRightSide) replaced by _side_ (left / right), FreeToUse usage rules renamed to OnInstant usage rules, OnState usage rules renamed to OnContingencyState usage rules |
| v1.7    | OnVoltageConstraint usage rules                                                                              |                                                                      | Extensions deprecated                                                                                                                                                                                           |
| v1.8    | Shunt Compensator set-point actions (new unit field in injection set-points that can be MW or section count) |                                                                      |                                                                                                                                                                                                                 |
| v1.9    | Counter-Trade Range Actions                                                                                  |                                                                      |                                                                                                                                                                                                                 |
| v2.0    | Instants                                                                                                     |                                                                      | Usage rules' usage method now mandatory                                                                                                                                                                         |
| v2.1    | Remedial Actions Usage Limits per Instant                                                                    |                                                                      |                                                                                                                                                                                                                 |
| v2.2    | `contingencyId` field in OnFlowConstraintInCountry usage rules                                               |                                                                      |                                                                                                                                                                                                                 |
| v2.3    | `RELATIVE_TO_PREVIOUS_TIME_STEP` RangeType, border attribute for CNECs                                       |                                                                      |                                                                                                                                                                                                                 |
| v2.4    | OnConstraint usage rules                                                                                     | OnAngleConstraint, OnFlowConstraint, OnVoltageConstraint usage rules | FlowCNEC thresholds'_side_ changed from left/right to 1/2, OnAngleConstraint, OnFlowConstraint, OnVoltageConstraint usage rules unified in OnConstraint usage rules                                             |
| v2.5    |                                                                                                              |                                                                      | Elementary network actions renaming to match PowSyBl core's names                                                                                                                                               |
